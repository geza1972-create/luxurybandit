...
export default function WelcomePage() {
  ...
  return (
    <main className="flex min-h-[100dvh] flex-col items-center justify-center lb-bg px-6 py-12 text-center text-white">
      ...
      <p className="mt-2 max-w-sm text-[15px] font-semibold leading-relaxed text-white/85">
      ...
      <div className="mt-6 w-full max-w-sm rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-left">
        <p className="text-[11px] font-black uppercase tracking-[0.14em] text-white/80">What happens next</p>
      ...
      <p className="mt-3 flex items-center gap-1.5 text-[12px] font-bold text-white/80">
