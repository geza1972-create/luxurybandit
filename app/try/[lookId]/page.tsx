...
const PROMPT_POOL = [
  "On a white-sand tropical beach with turquoise ocean waves behind her, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "In a grand marble palace hall with crystal chandeliers and tall gold-framed mirrors, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "On a modern city rooftop at night with a glowing skyline and warm neon lights behind her, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "In a lush tropical jungle beside a cascading waterfall with soft mist, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "In a cozy alpine chalet with a glowing fireplace and warm wooden interior, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "In an autumn park with golden falling leaves and soft afternoon light, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "By a sleek modern infinity pool at a hilltop villa at golden hour, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "On a Venetian palazzo balcony overlooking the Grand Canal at golden sunset, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "On a Santorini clifftop terrace with white walls and blue domes above the Aegean sea, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "On the deck of a luxury yacht on the open blue sea under a bright clear sky, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "On a Parisian rooftop terrace with the Eiffel Tower in the background at dusk, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
  "In a blooming cherry-blossom garden with soft pink petals drifting in the air, @1 presents the @2. She turns slowly all the way around to show it from every side, then walks a few relaxed steps toward the camera. Keep @1 face and appearance and the @2 exactly the same throughout. Fluid natural motion, photorealistic, high-end look. No text or logos.",
];
