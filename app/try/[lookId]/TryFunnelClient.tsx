...
// Die Szenen wohnen jetzt in lib/tryon-szenen.ts — dieselbe Liste benutzt der neue
// Tunnel (/themes/tryon). Siehe Skill `tryon-backgrounds`.
const pickPrompt = tryonPromptZiehen;
...
export default function TryFunnelClient() {
