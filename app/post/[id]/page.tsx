    ...
    <div className="mx-auto min-h-screen w-full max-w-[480px] overflow-x-hidden bg-white pb-20 shadow-sm">
      ...
      <div className="relative bg-black/5">
        {post.userPhotoUrl ? (
          ...
          <div className="aspect-[9/16] max-h-[75dvh] w-full overflow-hidden lb-media-bg">
            {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      <div className="px-4 py-3 flex flex-col gap-3">
        ...
        {!post.creatorDeleted && (
          <div className="flex items-center gap-2">
            <a href={`/try/${post.lookId}${post.userPhotoUrl ? `?model=${encodeURIComponent(post.userPhotoUrl)}` : ""}`}
