...
const TEXTE: Record<string, Copy> = {
  de: {
    ...
    kontrast: "Du bekommst eine eigene Webseite — in drei Sprachen, mit deinem Video und einem Chat, über den Firmen dich direkt erreichen. Deine Bewerbung liegt nicht als PDF in einem Postfach, sie hat eine Adresse. Das bekommst du nirgendwo sonst.",
  ...
  en: {
    ...
    kontrast: "You get your own web page — in three languages, with your video and a chat companies use to reach you directly. Your application isn't a PDF in an inbox, it has an address. You won't get that anywhere else.",
  ...
  ro: {
    ...
    kontrast: "Primești propria ta pagină web — în trei limbi, cu videoul tău și un chat prin care firmele te contactează direct. Aplicația ta nu e un PDF într-o căsuță de e-mail, are o adresă. Asta nu găsești nicăieri altundeva.",
  ...
  es: {
    ...
    kontrast: "Recibes tu propia página web — en tres idiomas, con tu vídeo y un chat con el que las empresas te contactan directamente. Tu candidatura no es un PDF en un buzón, tiene una dirección. Eso no lo encuentras en ningún otro sitio.",
  ...
  fr: {
    ...
    kontrast: "Tu reçois ta propre page web — en trois langues, avec ta vidéo et un chat par lequel les entreprises te contactent directement. Ta candidature n'est pas un PDF dans une boîte mail, elle a une adresse. Ça, tu ne le trouves nulle part ailleurs.",
  ...
  pt: {
    ...
    kontrast: "Recebes a tua própria página web — em três línguas, com o teu vídeo e um chat através do qual as empresas te contactam diretamente. A tua candidatura não é um PDF numa caixa de correio, tem um endereço. Isso não encontras em mais lado nenhum.",
  ...
  it: {
    ...
    kontrast: "Ricevi la tua pagina web — in tre lingue, con il tuo video e una chat con cui le aziende ti contattano direttamente. La tua candidatura non è un PDF in una casella di posta, ha un indirizzo. Questo non lo trovi da nessun'altra parte.",
