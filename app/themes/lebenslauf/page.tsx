...
const TEXTE: Record<string, Copy> = {
  de: {
    ...
    preisEinmal: "je Bewerbung — Skript, Video und fertige Seite",
    preisMonat: "im Monat — deine Bewerbungen bleiben online, monatlich kündbar",
  ...
  en: {
    ...
    preisEinmal: "per application — script, video and finished page",
    preisMonat: "per month — your applications stay online, cancel monthly",
  ...
  ro: {
    ...
    preisEinmal: "pentru fiecare aplicare — scenariu, video și pagină gata",
    preisMonat: "pe lună — aplicările tale rămân online, anulezi lunar",
  ...
  es: {
    ...
    preisEinmal: "por candidatura — guion, vídeo y página terminada",
    preisMonat: "al mes — tus candidaturas siguen online, cancelable cada mes",
  ...
  fr: {
    ...
    preisEinmal: "par candidature — script, vidéo et page terminée",
    preisMonat: "par mois — tes candidatures restent en ligne, résiliable chaque mois",
  ...
  pt: {
    ...
    preisEinmal: "por candidatura — guião, vídeo e página pronta",
    preisMonat: "por mês — as tuas candidaturas ficam online, cancelável todos os meses",
  ...
  it: {
    ...
    preisEinmal: "per candidatura — copione, video e pagina finita",
    preisMonat: "al mese — le tue candidature restano online, disdici ogni mese",
