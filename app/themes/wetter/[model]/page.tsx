...
const META: Record<string, (n: string) => { t: string; d: string; ot: string; od: string }> = {
  en: n => ({ t: `Morning weather with ${n} — a message every morning`, d: `${n} wakes you up every morning: your weather, a new look and a chat with her.`, ot: `Morning weather with ${n}`, od: `A message from ${n} every morning — weather, a new look, a chat.` }),
  de: n => ({ t: `Wetter am Morgen mit ${n} — jeden Morgen eine Nachricht`, d: `${n} weckt dich jeden Morgen: dein Wetter, ein neuer Look und ein Chat mit ihr.`, ot: `Wetter am Morgen mit ${n}`, od: `Jeden Morgen eine Nachricht von ${n} — Wetter, neuer Look, Chat.` }),
  ro: n => ({ t: `Vremea de dimineață cu ${n} — un mesaj în fiecare dimineață`, d: `${n} te trezește în fiecare dimineață: vremea ta, un look nou și un chat cu ea.`, ot: `Vremea de dimineață cu ${n}`, od: `Un mesaj de la ${n} în fiecare dimineață — vremea, un look nou, un chat.` }),
  es: n => ({ t: `El tiempo por la mañana con ${n} — un mensaje cada día`, d: `${n} te despierta cada mañana: tu clima, un look nuevo y un chat con ella.`, ot: `El tiempo por la mañana con ${n}`, od: `Un mensaje de ${n} cada mañana — el tiempo, un look nuevo, un chat.` }),
  fr: n => ({ t: `La météo du matin avec ${n} — un message chaque matin`, d: `${n} te réveille chaque matin : ta météo, un nouveau look et un chat avec elle.`, ot: `La météo du matin avec ${n}`, od: `Un message de ${n} chaque matin — la météo, un nouveau look, un chat.` }),
  pt: n => ({ t: `O tempo de manhã com ${n} — uma mensagem todos os dias`, d: `${n} acorda-te todas as manhãs: o teu tempo, um novo visual e uma conversa com ela.`, ot: `O tempo de manhã com ${n}`, od: `Uma mensagem da ${n} todas as manhãs — o tempo, um novo visual, uma conversa.` }),
  it: n => ({ t: `Il meteo del mattino con ${n} — un messaggio ogni mattina`, d: `${n} ti sveglia ogni mattina: il tuo meteo, un look nuovo e una chat con lei.`, ot: `Il meteo del mattino con ${n}`, od: `Un messaggio di ${n} ogni mattina — meteo, look nuovo, chat.` }),
};
...
// pl ist seit 30.07.2026 aus dem Portal (Hausregel, lib/lang.ts ist die Quelle).
const LANGS = ["ro", "de", "en", "es", "fr", "pt", "it"] as const;
