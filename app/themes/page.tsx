...
export const metadata = {
  ...
  description: "One place for AI influencers: chat with an AI model, try on any look in a video, make a kiss or deepfake video with your own photo, get a birthday video with a name. 24,50 €/month incl. 5 videos across all topics; chatting is free.",
...
const C: Record<string, PageCopy> = {
  ro: { kicker: "LuxuryBandit", h1a: "Alege o temă.", h1b: "Primește-o zilnic.", intro: "Fiecare temă îți trimite conținut zilnic de la influencerul tău — plus un chat cu ea.",
    ...
    canH: "Ce poți face?", costH: "Cât costă?", costP: "Chatul este gratuit. Abonamentul este pentru imagini și videoclipuri: 24,50 € pe lună, cu 5 videoclipuri lunar, în toate temele la un loc. Videoclipul de ziua de naștere costă 3,99 € o singură dată. Te poți dezabona oricând.",
  ...
  de: { kicker: "LuxuryBandit", h1a: "Wähle ein Thema.", h1b: "Bekomm es jeden Tag.", intro: "Jedes Thema schickt dir täglich Inhalte von deiner Influencerin — dazu ein Chat mit ihr.",
    ...
    canH: "Was kannst du damit machen?", costH: "Was kostet es?", costP: "Chatten ist gratis. Das Abo ist für Bilder und Videos: 24,50 € im Monat, darin sind 5 Videos monatlich enthalten — über alle Themen zusammen. Ein Geburtstagsvideo kostet einmalig 3,99 €. Du kannst dich jederzeit abmelden.",
  ...
  en: { kicker: "LuxuryBandit", h1a: "Pick a topic.", h1b: "Get it every day.", intro: "Each topic sends daily content from your influencer — plus a chat with her.",
    ...
    canH: "What can you do with it?", costH: "How much does it cost?", costP: "Chatting is free. The subscription is for pictures and videos: 24,50 € per month, including 5 videos a month across all topics together. A birthday video is a one-off €3.99. You can unsubscribe at any time.",
  ...
  es: { kicker: "LuxuryBandit", h1a: "Elige un tema.", h1b: "Recíbelo cada día.", intro: "Cada tema te envía contenido diario de tu influencer — además de un chat con ella.",
    ...
    canH: "¿Qué puedes hacer?", costH: "¿Cuánto cuesta?", costP: "Chatear es gratis. La suscripción es para las fotos y los vídeos: 24,50 € al mes, que incluye 5 vídeos mensuales en todos los temas juntos. Un vídeo de cumpleaños cuesta 3,99 € una sola vez. Puedes darte de baja cuando quieras.",
  ...
  fr: { kicker: "LuxuryBandit", h1a: "Choisis un thème.", h1b: "Reçois-le chaque jour.", intro: "Chaque thème t'envoie du contenu quotidien de ton influenceuse — et un chat avec elle.",
    ...
    canH: "Que peux-tu faire ?", costH: "Combien ça coûte ?", costP: "Le chat est gratuit. L'abonnement couvre les photos et les vidéos : 24,50 € par mois, avec 5 vidéos par mois pour tous les thèmes réunis. Une vidéo d'anniversaire coûte 3,99 € une seule fois. Tu peux te désabonner à tout moment.",
  ...
  pt: { kicker: "LuxuryBandit", h1a: "Escolhe um tema.", h1b: "Recebe-o todos os dias.", intro: "Cada tema envia-te conteúdo diário da tua influencer — e uma conversa com ela.",
    ...
    canH: "O que podes fazer?", costH: "Quanto custa?", costP: "Conversar é grátis. A subscrição é para as fotos e os vídeos: 24,50 € por mês, com 5 vídeos por mês em todos os temas juntos. Um vídeo de aniversário custa 3,99 € uma única vez. Podes cancelar quando quiseres.",
  ...
  it: { kicker: "LuxuryBandit", h1a: "Scegli un tema.", h1b: "Ricevilo ogni giorno.", intro: "Ogni tema ti manda contenuti quotidiani dalla tua influencer — più una chat con lei.",
    ...
    canH: "Cosa puoi fare?", costH: "Quanto costa?", costP: "Chattare è gratis. L'abbonamento è per foto e video: 24,50 € al mese, con 5 video al mese in tutti i temi insieme. Un video di compleanno costa 3,99 € una volta sola. Puoi disdire quando vuoi.",
