...
export const metadata = {
  ...
  description: "One place for AI influencers: chat with an AI model, try on any look in a video, make a kiss or deepfake video with your own photo, get a birthday video with a name. 49 €/month incl. 5 videos.",
...
const C: Record<string, PageCopy> = {
  ro: { kicker: "LuxuryBandit", h1a: "Alege o temă.", h1b: "Primește-o zilnic.", intro: "Fiecare temă îți trimite conținut zilnic de la influencerul tău — plus un chat cu ea.",
    ...
    canH: "Ce poți face?", costH: "Cât costă?", costP: "Mesajul zilnic și chatul sunt incluse într-un abonament: 49 € pe lună, cu 5 videoclipuri lunar. Videoclipul de ziua de naștere costă 3,99 € o singură dată. Te poți dezabona oricând.",
  ...
  de: { kicker: "LuxuryBandit", h1a: "Wähle ein Thema.", h1b: "Bekomm es jeden Tag.", intro: "Jedes Thema schickt dir täglich Inhalte von deiner Influencerin — dazu ein Chat mit ihr.",
    ...
    canH: "Was kannst du damit machen?", costH: "Was kostet es?", costP: "Die tägliche Nachricht und der Chat laufen über ein Abo: 49 € im Monat, darin sind 5 Videos monatlich enthalten. Ein Geburtstagsvideo kostet einmalig 3,99 €. Du kannst dich jederzeit abmelden.",
  ...
  en: { kicker: "LuxuryBandit", h1a: "Pick a topic.", h1b: "Get it every day.", intro: "Each topic sends daily content from your influencer — plus a chat with her.",
    ...
    canH: "What can you do with it?", costH: "How much does it cost?", costP: "The daily message and the chat run on one subscription: 49 € per month, including 5 videos a month. A birthday video is a one-off €3.99. You can unsubscribe at any time.",
  ...
  es: { kicker: "LuxuryBandit", h1a: "Elige un tema.", h1b: "Recíbelo cada día.", intro: "Cada tema te envía contenido diario de tu influencer — además de un chat con ella.",
    ...
    canH: "¿Qué puedes hacer?", costH: "¿Cuánto cuesta?", costP: "El mensaje diario y el chat van en una suscripción: 49 € al mes, que incluye 5 vídeos mensuales. Un vídeo de cumpleaños cuesta 3,99 € una sola vez. Puedes darte de baja cuando quieras.",
  ...
  fr: { kicker: "LuxuryBandit", h1a: "Choisis un thème.", h1b: "Reçois-le chaque jour.", intro: "Chaque thème t'envoie du contenu quotidien de ton influenceuse — et un chat avec elle.",
    ...
    canH: "Que peux-tu faire ?", costH: "Combien ça coûte ?", costP: "Le message quotidien et le chat font partie d'un abonnement : 49 € par mois, qui comprend 5 vidéos par mois. Une vidéo d'anniversaire coûte 3,99 € une seule fois. Tu peux te désabonner à tout moment.",
  ...
  pt: { kicker: "LuxuryBandit", h1a: "Escolhe um tema.", h1b: "Recebe-o todos os dias.", intro: "Cada tema envia-te conteúdo diário da tua influencer — e uma conversa com ela.",
    ...
    canH: "O que podes fazer?", costH: "Quanto custa?", costP: "A mensagem diária e a conversa fazem parte de uma subscrição: 49 € por mês, que inclui 5 vídeos por mês. Um vídeo de aniversário custa 3,99 € uma única vez. Podes cancelar quando quiseres.",
  ...
  pl: { kicker: "LuxuryBandit", h1a: "Wybierz temat.", h1b: "Dostawaj go codziennie.", intro: "Każdy temat przysyła Ci codzienne treści od Twojej influencerki — plus czat z nią.",
    ...
    canH: "Co możesz robić?", costH: "Ile to kosztuje?", costP: "Codzienna wiadomość i czat są w abonamencie: 49 € miesięcznie, który zawiera 5 filmów w miesiącu. Film urodzinowy kosztuje jednorazowo 3,99 €. Możesz zrezygnować w każdej chwili.",
  ...
  it: { kicker: "LuxuryBandit", h1a: "Scegli un tema.", h1b: "Ricevilo ogni giorno.", intro: "Ogni tema ti manda contenuti quotidiani dalla tua influencer — più una chat con lei.",
    ...
    canH: "Cosa puoi fare?", costH: "Quanto costa?", costP: "Il messaggio quotidiano e la chat sono in un abbonamento: 49 € al mese, che include 5 video al mese. Un video di compleanno costa 3,99 € una volta sola. Puoi disdire quando vuoi.",
