...
const C: Record<string, PageCopy> = {
  ...
  it: { kicker: "LuxuryBandit", h1a: "Scegli un tema.", h1b: "Fai il tuo video.", intro: "La tua foto, la tua influencer, il tuo video — più una chat con lei. Le novità arrivano ogni tanto, non ogni giorno.",
    ...
    canH: "Cosa puoi fare?", costH: "Quanto costa?", costP: "Chattare è gratis. L'abbonamento è per immagini e video: {price} al mese, con {videos} video su tutti i temi. Ogni video in più costa {extra}. Senza abbonamento un video costa {once}. Disdici quando vuoi.",
