...
type PageCopy = {
  ...
  whatH: string; whatP: string; canH: string; costH: string; costP: string; noteH: string; noteP: string;
  items: [string, string][];
};
const C: Record<string, PageCopy> = {
  ro: { kicker: "LuxuryBandit", h1a: "Alege o temă.", h1b: "Primește-o zilnic.", intro: "Fiecare temă îți trimite conținut zilnic de la influencerul tău — plus un chat cu ea.",
    ...
    canH: "Ce poți face?", costH: "Cât costă?", costP: "Mesajul zilnic și chatul sunt incluse într-un abonament de 24 € pe lună, cu 5 videoclipuri lunar. Videoclipul de ziua de naștere costă 3,99 € o singură dată. Te poți dezabona oricând.",
    noteH: "Bine de știut", noteP: "LuxuryBandit este doar pentru adulți — confirmi că ai peste 18 ani înainte de chat. Persona AI flirtează și te întreabă cum a fost ziua ta, dar nu pretinde niciodată sentimente și nu se dă drept persoană reală.",
  ...
  de: { kicker: "LuxuryBandit", h1a: "Wähle ein Thema.", h1b: "Bekomm es jeden Tag.", intro: "Jedes Thema schickt dir täglich Inhalte von deiner Influencerin — dazu ein Chat mit ihr.",
    ...
    canH: "Was kannst du damit machen?", costH: "Was kostet es?", costP: "Die tägliche Nachricht und der Chat laufen über ein Abo für 24 € im Monat, darin sind 5 Videos monatlich enthalten. Ein Geburtstagsvideo kostet einmalig 3,99 €. Du kannst dich jederzeit abmelden.",
    noteH: "Gut zu wissen", noteP: "LuxuryBandit ist nur für Erwachsene — du bestätigst vor dem Chat, dass du 18 oder älter bist. Die KI-Persona flirtet und fragt nach deinem Tag, behauptet aber nie Gefühle und gibt sich nie als echte Person aus.",
  ...
  en: { kicker: "LuxuryBandit", h1a: "Pick a topic.", h1b: "Get it every day.", intro: "Each topic sends daily content from your influencer — plus a chat with her.",
    ...
    canH: "What can you do with it?", costH: "How much does it cost?", costP: "The daily message and the chat run on one subscription of €24 per month, which includes 5 videos a month. A birthday video is a one-off €3.99. You can unsubscribe at any time.",
    noteH: "Good to know", noteP: "LuxuryBandit is for adults only — you confirm you are 18 or older before you can chat. The AI persona flirts and asks about your day, but never claims feelings and never pretends to be a real person.",
    items: [["Morning Weather","every morning she sends you a message: the weather where you are, a new look of hers, and a chat."],["Try-On","pick an outfit and a model, and watch her wear it in a video, from every angle."],["Lingerie & Luxury Looks","the same, in her most elegant and most intimate looks."],["Kiss any Model","upload your photo and see the two of you share a kiss."],["Your Idol with you","pick your idol and see the two of you together at a party."],["Birthday videos","type a name and she wishes them a happy birthday out loud, by name."],["Holiday with Bella","she travels for you and brings back videos and stories every day."]] },
  es: { kicker: "LuxuryBandit", h1a: "Elige un tema.", h1b: "Recíbelo cada día.", intro: "Cada tema te envía contenido diario de tu influencer — además de un chat con ella.",
    ...
    canH: "¿Qué puedes hacer?", costH: "¿Cuánto cuesta?", costP: "El mensaje diario y el chat van en una suscripción de 24 € al mes, que incluye 5 vídeos mensuales. Un vídeo de cumpleaños cuesta 3,99 € una sola vez. Puedes darte de baja cuando quieras.",
    noteH: "Bueno saberlo", noteP: "LuxuryBandit es solo para adultos — confirmas que tienes 18 años o más antes de chatear. La persona de IA coquetea y pregunta por tu día, pero nunca dice tener sentimientos ni finge ser una persona real.",
  ...
  fr: { kicker: "LuxuryBandit", h1a: "Choisis un thème.", h1b: "Reçois-le chaque jour.", intro: "Chaque thème t'envoie du contenu quotidien de ton influenceuse — et un chat avec elle.",
    ...
    canH: "Que peux-tu faire ?", costH: "Combien ça coûte ?", costP: "Le message quotidien et le chat font partie d'un abonnement à 24 € par mois, qui comprend 5 vidéos par mois. Une vidéo d'anniversaire coûte 3,99 € une seule fois. Tu peux te désabonner à tout moment.",
    noteH: "Bon à savoir", noteP: "LuxuryBandit est réservé aux adultes — tu confirmes avoir 18 ans ou plus avant de discuter. Le personnage IA flirte et demande comment s'est passée ta journée, mais ne prétend jamais avoir des sentiments ni être une vraie personne.",
  ...
  pt: { kicker: "LuxuryBandit", h1a: "Escolhe um tema.", h1b: "Recebe-o todos os dias.", intro: "Cada tema envia-te conteúdo diário da tua influencer — e uma conversa com ela.",
    ...
    canH: "O que podes fazer?", costH: "Quanto custa?", costP: "A mensagem diária e a conversa fazem parte de uma subscrição de 24 € por mês, que inclui 5 vídeos por mês. Um vídeo de aniversário custa 3,99 € uma única vez. Podes cancelar quando quiseres.",
    noteH: "Bom saber", noteP: "O LuxuryBandit é apenas para adultos — confirmas que tens 18 anos ou mais antes de conversar. A persona de IA flirta e pergunta pelo teu dia, mas nunca afirma ter sentimentos nem finge ser uma pessoa real.",
  ...
  pl: { kicker: "LuxuryBandit", h1a: "Wybierz temat.", h1b: "Dostawaj go codziennie.", intro: "Każdy temat przysyła Ci codzienne treści od Twojej influencerki — plus czat z nią.",
    ...
    canH: "Co możesz robić?", costH: "Ile to kosztuje?", costP: "Codzienna wiadomość i czat są w abonamencie za 24 € miesięcznie, który zawiera 5 filmów w miesiącu. Film urodzinowy kosztuje jednorazowo 3,99 €. Możesz zrezygnować w każdej chwili.",
    noteH: "Warto wiedzieć", noteP: "LuxuryBandit jest tylko dla dorosłych — przed czatem potwierdzasz, że masz 18 lat lub więcej. Persona AI flirtuje i pyta o Twój dzień, ale nigdy nie twierdzi, że ma uczucia, ani nie udaje prawdziwej osoby.",
  ...
  it: { kicker: "LuxuryBandit", h1a: "Scegli un tema.", h1b: "Ricevilo ogni giorno.", intro: "Ogni tema ti manda contenuti quotidiani dalla tua influencer — più una chat con lei.",
    ...
    canH: "Cosa puoi fare?", costH: "Quanto costa?", costP: "Il messaggio quotidiano e la chat sono in un abbonamento da 24 € al mese, che include 5 video al mese. Un video di compleanno costa 3,99 € una volta sola. Puoi disdire quando vuoi.",
    noteH: "Da sapere", noteP: "LuxuryBandit è solo per adulti — confermi di avere 18 anni o più prima di chattare. La persona IA flirta e ti chiede della tua giornata, ma non dichiara mai sentimenti e non finge di essere una persona reale.",
  ...
  return (
    <main className="lb-bg min-h-[100dvh] text-white">
      ...
      <div className="mx-auto max-w-3xl px-4 pb-24 pt-6">
        <p className="text-[11px] font-black uppercase tracking-[0.22em] text-amber-400">{c.kicker}</p>
        <h1 className="mt-1 text-[28px] font-black leading-tight tracking-tight">
          {c.h1a} <span className="text-amber-400">{c.h1b}</span>
        </h1>
