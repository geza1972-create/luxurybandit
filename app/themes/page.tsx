...
const C: Record<string, PageCopy> = {
  ...
  en: { kicker: "LuxuryBandit", h1a: "Pick a gift.", h1b: "Send it today.", intro: "Your photo and theirs — a kiss, a birthday, a surprise, a wedding invitation. Made in minutes, sent to one person. Nobody else sees it.",
    ...
    items: [["Send a kiss to the one you love","your photo and theirs — one video with the two of you, for them alone."],["Your wedding invitation","the two of you in the video, plus your own invitation page with RSVPs, news and a guest group."],["Chat with an AI girl","talk to her whenever you want — and dress her in new looks."],["Holiday with your dream girl","you pick the moment: beach, coffee, dancing."],["Birthday video","type a name — she says it out loud."],["Surprise him","your photo, a private video only he can open."]] },
  ...
  fr: { kicker: "LuxuryBandit", h1a: "Choisis un cadeau.", h1b: "Envoie-le aujourd'hui.", intro: "Ta photo et la sienne — un baiser, un vœu d'anniversaire, une surprise, une invitation de mariage. Prêt en quelques minutes, envoyé à une seule personne. Personne d'autre ne le voit.",
    ...
    items: [["Envoie un baiser à la personne que tu aimes","ta photo et la sienne — une vidéo avec vous deux, rien que pour elle."],["Votre invitation de mariage","vous deux dans la vidéo, plus votre page d'invitation avec réponses, nouvelles et groupe."],["Chatte avec une fille IA","parle-lui quand tu veux — et habille-la de nouveaux looks."],["Vacances avec la fille de tes rêves","tu choisis le moment : plage, café, danse."],["Vidéo d'anniversaire","tape un prénom — elle le dit à voix haute."],["Surprends-le","ta photo, une vidéo privée que lui seul peut ouvrir."]] },
