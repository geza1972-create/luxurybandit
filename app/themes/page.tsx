...
const C: Record<string, PageCopy> = {
  ro: { kicker: "VersusForge", h1a: "Funnels care vând.", h1b: "De la reclama Meta până la cumpărare.",
    models: "Vezi modelele noastre și vorbește cu ele →", wardrobe: "Garderobă",
    whatH: "Ce este VersusForge?",
  ...
  de: { kicker: "VersusForge", h1a: "Funnels, die verkaufen.", h1b: "Von der Meta-Anzeige bis zum Kauf.",
    models: "Unsere Models ansehen & mit ihnen chatten →", wardrobe: "Garderobe",
    whatH: "Was ist VersusForge?",
    uniqueH: "Warum wir", uniqueP: "Wir setzen auf Qualität statt Quantität. Statt Standardpakete und unnötigen Overhead zu finanzieren, entwickeln wir gezielt, was für das jeweilige Unternehmen funktioniert – mit weniger Streuverlust, schnelleren Lernzyklen und effizienterem Budgeteinsatz.",
  ...
  en: { kicker: "VersusForge", h1a: "Funnels that sell.", h1b: "From the Meta ad to the purchase.",
    models: "See our models & chat with them →", wardrobe: "Wardrobe",
    whatH: "What is VersusForge?",
  ...
  es: { kicker: "VersusForge", h1a: "Funnels que venden.", h1b: "Del anuncio de Meta a la compra.",
    models: "Ver nuestras modelos y chatear con ellas →", wardrobe: "Armario",
    whatH: "¿Qué es VersusForge?",
  ...
  fr: { kicker: "VersusForge", h1a: "Des funnels qui vendent.", h1b: "De la pub Meta à l'achat.",
    models: "Voir nos modèles et discuter avec elles →", wardrobe: "Dressing",
    whatH: "Qu'est-ce que VersusForge ?",
  ...
  pt: { kicker: "VersusForge", h1a: "Funnels que vendem.", h1b: "Do anúncio Meta à compra.",
    models: "Ver as nossas modelos e conversar com elas →", wardrobe: "Guarda-roupa",
    whatH: "O que é o VersusForge?",
  ...
  pl: { kicker: "VersusForge", h1a: "Wybierz prezent.", h1b: "Wyślij go dziś.",
    models: "Zobacz nasze modelki i porozmawiaj z nimi →", wardrobe: "Garderoba",
    whatH: "Czym jest VersusForge?",
  ...
  it: { kicker: "VersusForge", h1a: "Funnel che vendono.", h1b: "Dall'annuncio Meta all'acquisto.",
    models: "Guarda le nostre modelle e chatta con loro →", wardrobe: "Guardaroba",
    whatH: "Che cos'è VersusForge?",
