...
export const metadata = {
  ...
  description: "Upload your photo, pick her, pick the moment — a walk on the beach, a kiss, coffee, dancing. You make the videos yourself: 49 € a month for 25 videos across all topics, every extra one 3.99 €.",
      ...
      <div className="mx-auto w-full max-w-[440px] px-4 pb-24 pt-8">
        ...
        <section className="mt-14 space-y-8 border-t border-white/10 pt-10">
          ...
          <div>
            ...
            <Lead>
              The first video starts your subscription at 49 € a month: 25 videos a month across ALL
