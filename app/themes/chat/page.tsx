...
// und steckt sie in neue Looks: 24,50 €/Monat inkl. 25 Videos/Looks über ALLE Themen,
...
export const metadata = {
  ...
  description: "Pick any woman or upload your own photo of her, then text her every day. Your AI girl answers in your language and wears the looks you choose: Chat free; 24,50 €/month for 25 videos & looks across all topics, extra ones 3.99 €.",
...
export default async function ChatThemePage({ searchParams }: {
  ...
  const t = await trObject({
    ...
    fine: "Chatting is free. The subscription is for the pictures and videos: 24,50 € a month gives you 25 generations across ALL topics together. Every one beyond that is 3.99 €. She is an AI character, and she says so herself every so often.",
