  ...
  return (
    <main className="min-h-screen bg-[#0d0b0a] text-white">
      ...
      <div className="mx-auto w-full max-w-[440px] px-4 pb-24 pt-6">
        ...
        <p className="mt-1 text-[13px] font-medium text-white/70">Medien generieren/hochladen, Texte, Sichtbarkeit &amp; Seiten — für die General Card und pro Kunde.</p>
        ...
        {isAdmin === false && (
          <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-center">
            ...
            <p className="mt-1 text-[13px] text-white/55">Ohne Admin-PIN im Browser ist das Studio nicht sichtbar.</p>
          </div>
        )}
