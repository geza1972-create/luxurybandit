...
const EN: KissText = {
  ...
  probeHinweis: "Included for one month — send it to your guests, collect their answers. After that you keep it running with the subscription; the link and every answer stay.",
...
const DE: KissText = {
  ...
  probeHinweis: "Einen Monat inklusive — verschickt sie an eure Gäste und sammelt die Antworten. Danach haltet ihr sie mit dem Abo am Laufen; der Link und alle Antworten bleiben.",
...
const RO: KissText = {
  ...
  probeHinweis: "Inclusă pentru o lună — trimiteți-o invitaților și strângeți răspunsurile. Apoi o mențineți activă cu abonamentul; linkul și toate răspunsurile rămân.",
...
const ES: KissText = {
  ...
  probeHinweis: "Incluida durante un mes — enviadla a vuestros invitados y recoged las respuestas. Después la mantenéis activa con la suscripción; el enlace y todas las respuestas se quedan.",
...
const FR: KissText = {
  ...
  probeHinweis: "Incluse pendant un mois — envoyez-la à vos invités et récoltez les réponses. Ensuite vous la maintenez active avec l’abonnement ; le lien et toutes les réponses restent.",
...
const PT: KissText = {
  ...
  probeHinweis: "Incluído durante um mês — enviem-no aos convidados e recolham as respostas. Depois mantêm-no ativo com a subscrição; o link e todas as respostas ficam.",
...
const IT: KissText = {
  ...
  probeHinweis: "Incluso per un mese — inviatelo agli invitati e raccogliete le risposte. Poi lo mantenete attivo con l’abbonamento; il link e tutte le risposte restano.",
...
const HOCHZEIT: Record<Lang, Partial<KissText>> = {
  en: {
    ...
    heroA: "Your ",
    heroY: "wedding invitation",
    heroB: " 💍",
    heroLead: "One photo of you, one of him — the AI turns them into your wedding video. And the invitation is just the start: your page collects the RSVPs and menu choices, hosts the group chat and your announcements — your wedding planner in one link. Every video is {once} — no free trial.",
    ...
    freeNote: "The picture is yours, free. The invitation — page, RSVPs, news and group — is {price} a month, cancel any time. ",
  ...
  de: {
    ...
    heroA: "Eure ",
    heroY: "Hochzeitseinladung",
    heroB: " 💍",
    heroLead: "Ein Foto von dir, eins von ihm — die KI macht daraus euer Hochzeitsvideo. Und die Einladung ist erst der Anfang: Eure Seite sammelt Zusagen und Menüwünsche, führt den Gruppenchat und eure Ankündigungen — euer Hochzeitsplaner in einem Link. Jedes Video kostet {once} — kein Gratisversuch.",
  ...
  ro: {
    ...
    heroA: "Invitația voastră ",
    heroY: "de nuntă",
    heroB: " 💍",
    heroLead: "O poză cu tine, una cu el — inteligența artificială face din ele videoclipul vostru de nuntă. Iar invitația e doar începutul: pagina voastră adună confirmările și alegerile de meniu, găzduiește chatul de grup și anunțurile voastre — planificatorul vostru de nuntă într-un singur link. Fiecare videoclip costă {once} — fără probă gratuită.",
  ...
  es: {
    ...
    heroA: "Vuestra ",
    heroY: "invitación de boda",
    heroB: " 💍",
    heroLead: "Una foto tuya, una de él — la IA las convierte en vuestro vídeo de boda. Y la invitación es solo el principio: vuestra página reúne las confirmaciones y el menú de cada invitado, aloja el chat del grupo y vuestros avisos — vuestro organizador de boda en un solo enlace. Cada vídeo cuesta {once} — sin prueba gratuita.",
  ...
  fr: {
    ...
    heroA: "Votre ",
    heroY: "faire-part de mariage",
    heroB: " 💍",
    heroLead: "Une photo de toi, une de lui — l’IA en fait votre vidéo de mariage. Et l’invitation n’est que le début : votre page rassemble les réponses et les choix de menu, héberge la discussion de groupe et vos annonces — votre organisateur de mariage en un seul lien. Chaque vidéo coûte {once} — pas d’essai gratuit.",
  ...
  pt: {
    ...
    heroA: "O vosso ",
    heroY: "convite de casamento",
    heroB: " 💍",
    heroLead: "Uma foto tua, uma dele — a IA transforma-as no vosso vídeo de casamento. E o convite é só o começo: a vossa página reúne as confirmações e as escolhas de menu, aloja o chat do grupo e os vossos avisos — o vosso organizador do casamento num único link. Cada vídeo custa {once} — sem teste grátis.",
  ...
  it: {
    ...
    heroA: "Il vostro ",
    heroY: "invito di matrimonio",
    heroB: " 💍",
    heroLead: "Una foto tua, una di lui — l’IA le trasforma nel vostro video di nozze. E l’invito è solo l’inizio: la vostra pagina raccoglie le conferme e le scelte del menù, ospita la chat di gruppo e i vostri avvisi — il vostro wedding planner in un unico link. Ogni video costa {once} — nessuna prova gratuita.",
