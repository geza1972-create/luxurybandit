...
const EN: KissText = {
  ...
  bekommst: [
    ...
    "A guest list: you see who said yes — or they message you on WhatsApp",
...
const DE: KissText = {
  ...
  bekommst: [
    ...
    "Eine Gästeliste: Ihr seht, wer zugesagt hat — oder sie schreiben euch per WhatsApp",
...
const RO: KissText = {
  ...
  bekommst: [
    ...
    "O listă de invitați: vedeți cine a confirmat — sau vă scriu pe WhatsApp",
...
const ES: KissText = {
  ...
  bekommst: [
    ...
    "Una lista de invitados: veis quién ha confirmado — o os escriben por WhatsApp",
...
const FR: KissText = {
  ...
  bekommst: [
    ...
    "Une liste d’invités : vous voyez qui a répondu oui — ou ils vous écrivent sur WhatsApp",
...
const PT: KissText = {
  ...
  bekommst: [
    ...
    "Uma lista de convidados: veem quem confirmou — ou escrevem-vos no WhatsApp",
...
const IT: KissText = {
  ...
  bekommst: [
    ...
    "Una lista invitati: vedete chi ha confermato — o vi scrivono su WhatsApp",
