...
const HOCHZEIT: Record<Lang, Partial<KissText>> = {
  en: {
    ...
    makeVideo: "Create our invitation — {price}/month 💍",
    ...
    heroB: " 💍",
    heroLead: "One photo of you, one of him — the AI turns them into your wedding video. You get your own invitation page with your names, the date and the address, and one link for WhatsApp. Your guests tap once to say yes; you see the list. The first picture is free.",
  ...
  de: {
    ...
    makeVideo: "Unsere Einladung erstellen — {price}/Monat 💍",
    ...
    heroB: " 💍",
    heroLead: "Ein Foto von dir, eins von ihm — die KI macht daraus euer Hochzeitsvideo. Dazu bekommt ihr eine eigene Einladungsseite mit Namen, Datum und Adresse und einen Link für WhatsApp. Eure Gäste sagen mit einem Tipp zu, ihr seht die Liste. Das erste Bild ist gratis.",
  ...
  ro: {
    ...
    makeVideo: "Creează invitația — {price}/lună 💍",
    ...
    heroY: "de nuntă",
    heroB: " 💍",
    heroLead: "O poză cu tine, una cu el — inteligența artificială face din ele videoclipul vostru de nuntă. Primiți o pagină de invitație numai a voastră, cu nume, dată și adresă, și un link pentru WhatsApp. Invitații confirmă cu o atingere, voi vedeți lista. Prima imagine e gratuită.",
  ...
  es: {
    ...
    makeVideo: "Crear nuestra invitación — {price}/mes 💍",
    ...
    heroB: " 💍",
    heroLead: "Una foto tuya, otra de él — la IA hace con ellas vuestro vídeo de boda. Recibís vuestra propia página de invitación con nombres, fecha y dirección, y un enlace para WhatsApp. Vuestros invitados confirman con un toque, vosotros veis la lista. La primera imagen es gratis.",
  ...
  fr: {
    ...
    makeVideo: "Créer notre invitation — {price}/mois 💍",
    ...
    heroB: " 💍",
    heroLead: "Une photo de vous, une de lui — l’IA en fait votre vidéo de mariage. Vous recevez votre propre page d’invitation avec vos noms, la date et l’adresse, et un lien pour WhatsApp. Vos invités répondent oui d’un geste, vous voyez la liste. La première image est gratuite.",
  ...
  pt: {
    ...
    makeVideo: "Criar o nosso convite — {price}/mês 💍",
    ...
    heroB: " 💍",
    heroLead: "Uma foto tua, uma dele — a IA transforma-as no vosso vídeo de casamento. Recebem uma página de convite só vossa, com nomes, data e morada, e um link para o WhatsApp. Os convidados confirmam com um toque, vocês veem a lista. A primeira imagem é grátis.",
  ...
  it: {
    ...
    makeVideo: "Crea il nostro invito — {price}/mese 💍",
    ...
    heroB: " 💍",
    heroLead: "Una foto tua, una di lui — l’IA ne fa il vostro video di nozze. Ricevete una pagina d’invito tutta vostra, con nomi, data e indirizzo, e un link per WhatsApp. I vostri invitati confermano con un tocco, voi vedete la lista. La prima immagine è gratis.",
