...
const GEBURTSTAG: Record<Lang, Partial<KissText>> = {
  ...
  de: {
    ...
    ctaVideo: "5 Sek. Video — {geburtstag}",
  ...
  ro: {
    ...
    ctaVideo: "Video de 5 s — {geburtstag}",
  ...
  es: {
    ...
    ctaVideo: "Vídeo de 5 s — {geburtstag}",
  ...
  fr: {
    ...
    ctaVideo: "Vidéo de 5 s — {geburtstag}",
  ...
  it: {
    ...
    ctaVideo: "Video da 5 s — {geburtstag}",
