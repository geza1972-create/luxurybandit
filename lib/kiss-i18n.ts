...
const HOCHZEIT: Record<Lang, Partial<KissText>> = {
  en: {
    ...
    makeVideo: "Create our invitation 💍",
  ...
  de: {
    ...
    makeVideo: "Unsere Einladung erstellen 💍",
  ...
  ro: {
    ...
    makeVideo: "Creează invitația noastră 💍",
  ...
  es: {
    ...
    makeVideo: "Crear nuestra invitación 💍",
  ...
  fr: {
    ...
    makeVideo: "Créer notre invitation 💍",
  ...
  pt: {
    ...
    makeVideo: "Criar o nosso convite 💍",
  ...
  it: {
    ...
    makeVideo: "Crea il nostro invito 💍",
