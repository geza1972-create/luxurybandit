...
const GEBURTSTAG: Record<Lang, Partial<KissText>> = {
  en: {
    ...
    wieGeht: ["Record yourself reading one sentence.", "Type the birthday name.", "Send the video — to them alone."],
    wieGehtPrivat: "Nobody else sees it. Your video stays private unless you send it yourself.",
    priceLine: "Video {geburtstag}", buyOnce: "Birthday video {geburtstag}",
    ctaVideo: "8 s video — {geburtstag}",
  ...
  de: {
    ...
    wieGeht: ["Nimm dich auf, wie du einen Satz vorliest.", "Schreib den Namen des Geburtstagskinds dazu.", "Schick das Video — nur ihm oder ihr."],
    ...
    ctaVideo: "8 Sek. Video — {geburtstag}",
  ...
  ro: {
    ...
    wieGeht: ["Filmează-te citind o propoziție.", "Scrie numele sărbătoritului.", "Trimite videoclipul — doar lui."],
    ...
    ctaVideo: "Video de 8 s — {geburtstag}",
  ...
  es: {
    ...
    wieGeht: ["Grábate leyendo una frase.", "Escribe el nombre del cumpleañero.", "Envía el vídeo — solo a esa persona."],
    ...
    ctaVideo: "Vídeo de 8 s — {geburtstag}",
  ...
  fr: {
    ...
    wieGeht: ["Filme-toi en lisant une phrase.", "Écris le prénom de la personne.", "Envoie la vidéo — à elle seule."],
    ...
    ctaVideo: "Vidéo de 8 s — {geburtstag}",
  ...
  pt: {
    ...
    wieGeht: ["Filma-te a ler uma frase.", "Escreve o nome do aniversariante.", "Envia o vídeo — só a essa pessoa."],
  ...
  it: {
    ...
    wieGeht: ["Filmati mentre leggi una frase.", "Scrivi il nome del festeggiato.", "Manda il video — solo a lui o lei."],
    ...
    ctaVideo: "Video da 8 s — {geburtstag}",
