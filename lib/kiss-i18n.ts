...
const HOCHZEIT: Record<Lang, Partial<KissText>> = {
  en: {
    ...
    readyTitle: "Your wedding video is ready 💍",
    makeVideo: "Make a real wedding video 💍",
    makingKiss: "Making your wedding video …",
    ...
    wardrobeOpen: "Pick her gown for the video.",
  ...
  de: {
    ...
    readyTitle: "Euer Hochzeitsvideo ist fertig 💍",
    makeVideo: "Echtes Hochzeitsvideo machen 💍",
    makingKiss: "Euer Hochzeitsvideo entsteht …",
    ...
    wardrobeOpen: "Wähle ihr Kleid für das Video.",
  ...
  ro: {
    ...
    readyTitle: "Videoclipul vostru de nuntă e gata 💍",
    makeVideo: "Fă un video real de nuntă 💍",
    makingKiss: "Se face videoclipul vostru de nuntă …",
    ...
    wardrobeOpen: "Alege-i rochia pentru videoclip.",
  ...
  es: {
    ...
    readyTitle: "Vuestro vídeo de boda está listo 💍",
    makeVideo: "Haz un vídeo de boda real 💍",
    makingKiss: "Creando vuestro vídeo de boda …",
    ...
    wardrobeOpen: "Elige su vestido para el vídeo.",
  ...
  fr: {
    ...
    readyTitle: "Votre vidéo de mariage est prête 💍",
    makeVideo: "Faire une vraie vidéo de mariage 💍",
    makingKiss: "Votre vidéo de mariage se fait …",
    ...
    wardrobeOpen: "Choisissez sa robe pour la vidéo.",
  ...
  pt: {
    ...
    readyTitle: "O vosso vídeo de casamento está pronto 💍",
    makeVideo: "Fazer um vídeo de casamento a sério 💍",
    makingKiss: "A fazer o vosso vídeo de casamento …",
    ...
    wardrobeOpen: "Escolham o vestido dela para o vídeo.",
  ...
  it: {
    ...
    readyTitle: "Il vostro video di matrimonio è pronto 💍",
    makeVideo: "Fai un vero video di matrimonio 💍",
    makingKiss: "Stiamo facendo il vostro video di matrimonio …",
    ...
    wardrobeOpen: "Scegliete il suo abito per il video.",
