...
const EN: KissText = {
  ...
  mailNote: "Free. We send you the picture, keep it in your gallery — and you agree that we may email you offers. One click to unsubscribe, any time.",
  ...
  privat: "🔒 Private: only you see your photos and your result. We never publish them and never show them to anyone.",
...
const DE: KissText = {
  ...
  mailNote: "Kostenlos. Wir schicken dir das Bild, heben es in deiner Galerie auf — und du stimmst zu, dass wir dir Angebote schicken dürfen. Abmelden mit einem Klick, jederzeit.",
  ...
  privat: "🔒 Privat: nur du siehst deine Fotos und dein Ergebnis. Wir veröffentlichen sie nie und zeigen sie niemandem.",
...
const RO: KissText = {
  ...
  mailNote: "Gratuit. Îți trimitem poza, o păstrăm în galeria ta — și ești de acord să îți trimitem oferte. Te dezabonezi cu un clic, oricând.",
  ...
  privat: "🔒 Privat: doar tu îți vezi pozele și rezultatul. Nu le publicăm niciodată și nu le arătăm nimănui.",
...
const ES: KissText = {
  ...
  mailNote: "Gratis. Te enviamos la imagen, la guardamos en tu galería — y aceptas que te enviemos ofertas. Cancelas con un clic, cuando quieras.",
  ...
  privat: "🔒 Privado: solo tú ves tus fotos y tu resultado. Nunca las publicamos ni se las enseñamos a nadie.",
...
const FR: KissText = {
  ...
  mailNote: "Gratuit. Nous t'envoyons l'image, la gardons dans ta galerie — et tu acceptes de recevoir nos offres. Désabonnement en un clic, à tout moment.",
  ...
  privat: "🔒 Privé : toi seul vois tes photos et ton résultat. Nous ne les publions jamais et ne les montrons à personne.",
...
const PT: KissText = {
  ...
  mailNote: "Grátis. Enviamos-te a imagem, guardamo-la na tua galeria — e aceitas receber as nossas ofertas. Cancelas com um clique, quando quiseres.",
  ...
  privat: "🔒 Privado: só tu vês as tuas fotos e o teu resultado. Nunca as publicamos nem as mostramos a ninguém.",
...
const IT: KissText = {
  ...
  mailNote: "Gratis. Ti mandiamo l'immagine, la teniamo nella tua galleria — e accetti di ricevere le nostre offerte. Ti disiscrivi con un clic, quando vuoi.",
  ...
  privat: "🔒 Privato: solo tu vedi le tue foto e il tuo risultato. Non le pubblichiamo mai e non le mostriamo a nessuno.",
