...
const EN: KissText = {
  ...
  bekommst: [
    ...
    "RSVPs come straight to your phone on WhatsApp",
...
const DE: KissText = {
  ...
  bekommst: [
    ...
    "Zusagen kommen per WhatsApp direkt auf euer Handy",
...
const RO: KissText = {
  ...
  bekommst: [
    ...
    "Confirmările ajung direct pe telefonul vostru, pe WhatsApp",
...
const ES: KissText = {
  ...
  bekommst: [
    ...
    "Las confirmaciones llegan directamente a vuestro móvil por WhatsApp",
...
const FR: KissText = {
  ...
  bekommst: [
    ...
    "Les réponses arrivent directement sur votre téléphone, par WhatsApp",
...
const PT: KissText = {
  ...
  bekommst: [
    ...
    "As confirmações chegam directamente ao vosso telemóvel, no WhatsApp",
...
const IT: KissText = {
  ...
  bekommst: [
    ...
    "Le conferme arrivano direttamente sul vostro telefono, su WhatsApp",
