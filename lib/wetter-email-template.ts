...
export function copy(lang: string, name: string): Copy {
  ...
  const T: Record<string, Copy> = {
    ...
    en: { subject: c("Good evening") + " \u2728", preheader: "Your weather for tomorrow and a new look.",
      ...
      aboH: "Unlock everything", aboP: "Pick the hottest looks yourself and generate them: any model — or your favourite star — in any look, in a chat, or in a kiss. 25 videos a month across all topics, chatting stays free.", aboCta: "Unlock the hottest AI experience ever — €24.50/month", whats: "💬 Follow on WhatsApp" },
    es: { subject: c("Buenas noches") + " \u2728", preheader: "Tu clima de mañana y un look nuevo.",
      ...
      aboH: "Desbloquea todo", aboP: "Eliges tú mismo los looks más atrevidos y los generas: cualquier modelo — o tu superestrella — con cualquier look, en un chat o en un beso. 25 vídeos al mes en todos los temas, chatear sigue gratis.", aboCta: "Desbloquea la experiencia IA más ardiente — 24,50 €/mes", whats: "💬 Síguenos en WhatsApp" },
    fr: { subject: c("Bonsoir") + " \u2728", preheader: "Ta météo de demain et un nouveau look.",
      ...
      aboH: "Tout débloquer", aboP: "Tu choisis toi-même les looks les plus chauds et tu les génères : n'importe quelle modèle — ou ta star préférée — dans n'importe quelle tenue, en chat ou dans un baiser. 25 vidéos par mois sur tous les thèmes, le chat reste gratuit.", aboCta: "Débloque l'expérience IA la plus chaude — 24,50 €/mois", whats: "💬 Suivre sur WhatsApp" },
    pt: { subject: c("Boa noite") + " \u2728", preheader: "O teu tempo de amanhã e um novo visual.",
      ...
      aboH: "Desbloqueia tudo", aboP: "Escolhes tu mesmo os looks mais atrevidos e geras: qualquer modelo — ou a tua estrela — em qualquer look, num chat ou num beijo. 25 vídeos por mês em todos os temas, conversar continua grátis.", aboCta: "Desbloqueia a experiência de IA mais quente — 24,50 €/mês", whats: "💬 Segue no WhatsApp" },
    pl: { subject: c("Dobry wieczór") + " \u2728", preheader: "Twoja pogoda na jutro i nowy look.",
      ...
      aboH: "Odblokuj wszystko", aboP: "Sam wybierasz najgorętsze stylizacje i je generujesz: dowolna modelka — albo Twoja gwiazda — w każdej stylizacji, na czacie albo w pocałunku. 25 filmów miesięcznie we wszystkich tematach, czat pozostaje darmowy.", aboCta: "Odblokuj najgorętsze doświadczenie AI — 24,50 €/miesiąc", whats: "💬 Obserwuj na WhatsAppie" },
    it: { subject: c("Buonasera") + " \u2728", preheader: "Il tuo meteo di domani e un nuovo look.",
      ...
      aboH: "Sblocca tutto", aboP: "Scegli tu i look più caldi e li generi: qualsiasi modella — o la tua star — in qualsiasi look, in chat o in un bacio. 25 video al mese in tutti i temi, chattare resta gratis.", aboCta: "Sblocca l'esperienza AI più calda — 24,50 €/mese", whats: "💬 Segui su WhatsApp" },
  };
  return T[lang] ?? T.en;
}
