...
export function copy(lang: string, name: string): Copy {
  ...
  const T: Record<string, Copy> = {
    ro: { subject: c("Bună dimineața") + " \u2600\uFE0F", preheader: "Vremea ta de azi și un look nou.",
      ...
      aboH: "Toate funcțiile, deblocate", aboP: "Alegi singur cele mai fierbinți ținute și le generezi: orice model — sau superstarul tău — în orice ținută, la chat sau într-un sărut. 25 de videoclipuri pe lună în toate temele, chatul rămâne gratuit.", aboCta: "Începe cu 19 € prima lună" },
    de: { subject: c("Guten Morgen") + " \u2600\uFE0F", preheader: "Dein Wetter für heute und ein neuer Look.",
      ...
      aboH: "Alle Funktionen freischalten", aboP: "Die heißesten Looks suchst du selbst aus und generierst sie: jedes Model — oder deinen Superstar — in jedem Look, im Chat, oder mit einem Kuss. 25 Videos im Monat über alle Themen, Chatten bleibt gratis.", aboCta: "Erster Monat 19 € starten" },
    en: { subject: c("Good morning") + " \u2600\uFE0F", preheader: "Your weather for today and a new look.",
      ...
      aboH: "Unlock everything", aboP: "Pick the hottest looks yourself and generate them: any model — or your favourite star — in any look, in a chat, or in a kiss. 25 videos a month across all topics, chatting stays free.", aboCta: "Start — €19 first month" },
    es: { subject: c("Buenos días") + " \u2600\uFE0F", preheader: "Tu clima de hoy y un look nuevo.",
      ...
      aboH: "Desbloquea todo", aboP: "Eliges tú mismo los looks más atrevidos y los generas: cualquier modelo — o tu superestrella — con cualquier look, en un chat o en un beso. 25 vídeos al mes en todos los temas, chatear sigue gratis.", aboCta: "Empieza — 19 € el primer mes" },
    fr: { subject: c("Bonjour") + " \u2600\uFE0F", preheader: "Ta météo du jour et un nouveau look.",
      ...
      aboH: "Tout débloquer", aboP: "Tu choisis toi-même les looks les plus chauds et tu les génères : n'importe quelle modèle — ou ta star préférée — dans n'importe quelle tenue, en chat ou dans un baiser. 25 vidéos par mois sur tous les thèmes, le chat reste gratuit.", aboCta: "Commencer — 19 € le 1er mois" },
    pt: { subject: c("Bom dia") + " \u2600\uFE0F", preheader: "O teu tempo de hoje e um novo visual.",
      ...
      aboH: "Desbloqueia tudo", aboP: "Escolhes tu mesmo os looks mais atrevidos e geras: qualquer modelo — ou a tua estrela — em qualquer look, num chat ou num beijo. 25 vídeos por mês em todos os temas, conversar continua grátis.", aboCta: "Começar — 19 € no 1.º mês" },
    pl: { subject: c("Dzień dobry") + " \u2600\uFE0F", preheader: "Twoja pogoda na dziś i nowy look.",
      ...
      aboH: "Odblokuj wszystko", aboP: "Sam wybierasz najgorętsze stylizacje i je generujesz: dowolna modelka — albo Twoja gwiazda — w każdej stylizacji, na czacie albo w pocałunku. 25 filmów miesięcznie we wszystkich tematach, czat pozostaje darmowy.", aboCta: "Zacznij — 19 € pierwszy miesiąc" },
    it: { subject: c("Buongiorno") + " \u2600\uFE0F", preheader: "Il tuo meteo di oggi e un nuovo look.",
      ...
      aboH: "Sblocca tutto", aboP: "Scegli tu i look più caldi e li generi: qualsiasi modella — o la tua star — in qualsiasi look, in chat o in un bacio. 25 video al mese in tutti i temi, chattare resta gratis.", aboCta: "Inizia — 19 € il primo mese" },
  };
  return T[lang] ?? T.en;
}
