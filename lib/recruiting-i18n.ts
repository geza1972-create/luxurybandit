...
const de: RecruitingText = {
  ...
  positionierung: "Deutschsprachige Kandidaten · Rumänien + Diaspora · Market Insight + Sourcing",
...
const ro: RecruitingText = {
  ...
  positionierung: "Vorbitori de germană · România + diaspora · Market insight + sourcing",
  kopfMotto: "Talent Market Pulse",
...
const en: RecruitingText = {
  ...
  positionierung: "German-speaking candidates · Romania + diaspora · Market insight + sourcing",
  kopfMotto: "Talent Market Pulse",
