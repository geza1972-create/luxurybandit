...
const TEXTE = {
  en: {
    ...
    /* Der Film zu EINEM Werk, in „Edit page" hochgeladen (Owner 20.09.2026). */
    filmTitel: "The story behind this work — your video",
    filmErklaerung: "Stand next to the work and tell its story, about a minute. It appears as its own slide on this poster, and behind its QR code.",
    wandFilmTitel: "This poster on a wall — video",
    wandFilmErklaerung: "A short clip of the poster being unpacked or hung. Shown as a slide next to the rooms.",
    filmWaehlen: "Choose video", filmErsetzen: "Replace video", filmSpeichern: "Save video", filmAbbrechen: "Cancel",
    filmLoeschen: "Delete video", filmLaedt: "Uploading …", filmGespeichert: "Saved — the video is on your poster.",
    filmFehler: "That did not work. Please try again.", filmZuGross: "The video is too large (max. 80 MB, about a minute).",
    filmNurVideo: "Please choose a video file.",
    ...
    stimmeSkriptAnfang: "My name is {name}.",
    stimmeSkriptHinweis: "A suggestion — correct it and save. Speak in your own words; the recording is you, not a text.",
    ...
    /**
     * ── DER STAND JEDES BILDES (Owner 18.09.2026: „dann steht auf Status ‚noch nicht
     * freigegeben' … dann bekommt er den Status ‚freigegeben'") ─────────────────────────────
     *
     * Drei Zustände, drei Sätze. Der abgelehnte trägt zusätzlich die Gründe — sie kommen aus
     * derselben Liste, die der Owner angeklickt hat, damit Mail und Dashboard dasselbe sagen.
     */
    /* Dieselben Sätze wie in der Absage-Mail (`versusforge-mail-texte`) — der Künstler soll im
       Dashboard nicht andere Worte lesen als in seiner Post. */
    grundSchief: "The artwork is photographed at an angle",
    grundUmgebung: "More of the room is visible than of the artwork",
    grundUnscharf: "The photo is blurry or too dark",
    grundSpiegelung: "Glare or flash on the artwork",
    grundRahmen: "Frame, hands or furniture in the picture",
    grundPasst: "Does not fit our portal",
    standLeer: "No picture here yet — upload one",
    standFrei: "Published",
    standPruefung: "Not released yet — we are looking at it",
    standAbgelehnt: "Not released — please replace this picture",
    freistellen: "Crop to the artwork",
    freistellenLaeuft: "Finding the edges…",
    freistellenZurueck: "Back to the original",
    freistellenNichts: "The edges of the artwork could not be found.",
    ...
    posterPreisWort: "Poster price (A3, no frame), €",
    posterPreisPlatzhalter: "e.g. 89 — empty = standard price",
    ...
    /* ── DEIN EIGENES BILD, KEINE LIZENZ (Owner 18.09.2026: „wenn das Bild nicht generiert ist,
       dann darf man keine Lizenz verlangen" · „1 Euro bekommt der Künstler") ───────────────── */
    druckVerkaufEigenes: "This is your own picture on our sheet — nothing of the artist is on it, so there is no licence fee. {anteil} goes to the artist as a referral, because you came through their page.",
    ...
    /**
     * ── DIE RUBRIK OBEN AUF DER STARTSEITE (Owner 18.09.2026: „ich brauche auch so eine Rubrik"
     * · „du musst einige Artikel so bauen") ──────────────────────────────────────────────────
     *
     * Drei Türen, bevor die Wischreihen kommen: das grosse Bild sagt, was für ein Laden das ist,
    ...
    rubrikEinsText: "A printed poster — until you scan it. Then your phone plays the music and tells you the story of the work.",
    rubrikEinsLink: "Discover posters",
    rubrikZweiKicker: "Old masters",
    rubrikZweiTitel: "Van Gogh, Klimt, Vermeer and more",
    rubrikZweiText: "Works in the public domain, printed to order on real paper — and your own face can step into one of them.",
    rubrikZweiLink: "Discover the masters",
    ...
    wenigerLesen: "Less",
    seiteWeiter: "Next",
    /* Nachladen statt Blättern (Owner 19.09.2026): Der Knopf sagt, wie viel noch kommt. */
    /* Die grosse Rubrik wirbt für den Künstler, dessen Werk umgebaut werden darf (Owner
       19.09.2026: „mach lieber Werbung für Caricaturist. Dein Bild als Karikatur"). */
    /* Der Knopf auf dem Blatt (Owner 19.09.2026: „hier muss fett stehen Generează caricatura,
       aber 4,99 Euro"). `{preis}` kommt aus `KUNST_CENTS` — nie eine Zahl in den Text tippen. */
    /* Die Absagen am Knopf (Owner 19.09.2026) — sie standen fest englisch im Bauteil, auf einer
       rumänischen Seite. Ein Knopf, der Rumänisch spricht und Englisch antwortet, wirkt kaputt. */
    /* Steht am Knopf, wenn die Datei schon im Erzeugen-Preis steckt (Owner 19.09.2026). */
    /* Etiketten im Dashboard (Owner 19.09.2026) — damit niemand mehr die Zeile AUF dem Blatt
       für das Feld hält, das speichert. */
    blattName: "Your artist name — stands large on every sheet that has no title of its own.",
    blattFelder: "On the sheet: the title stands large, your name and the year small underneath.",
    kunstDateiFrei: "Free",
    kunstZahlungAus: "Payment is unavailable right now.",
    kunstZahlungDa: "Payment received — press the button again.",
    /* ── WÄHREND AUF DIE BUCHUNG GEWARTET WIRD (Owner 19.09.2026: „was passiert hier gerade?")
       Der Kreisel sagte „wird gezeichnet", obwohl kein Modell lief — die Seite wartete auf die
       Zahlung. Wer das liest, hält einen Fehler für Arbeit und schaut zwei Minuten zu. */
    kunstZahlungWartet: "Confirming your payment…",
    kunstZahlungWeg: "We did not receive a payment. Press the button to try again.",
    kunstWerkGesperrt: "This artwork can't be used.",
    kunstFotoAbgelehnt: "Not allowed — try another photo.",
    kunstNichtHier: "Not available for this artwork.",
    kunstFehlgeschlagen: "Didn't work — try again.",
    kunstNurBilder: "Only JPG, PNG or WebP.",
    kunstZuGross: "Max. 20 MB.",
    /* Die Anleitung am Blatt (Owner 19.09.2026: „hier muss klarer werden, was der User machen
       soll"). Zwei Schritte, je nachdem, ob schon ein Foto im Blatt steht. */
    /* Das Etikett an einem Generator-Blatt (Owner 19.09.2026: „ja, ab 10"). `{preis}` kommt aus
       `KUNST_CENTS` — nie eine Zahl tippen. */
    /* Die Mail mit dem fertigen Blatt (Owner 19.09.2026: „keine Email"). */
    /* Das Fenster auf dem Blatt (Owner 19.09.2026: „es müsste ein Fenster sich öffnen für Bild,
       Texte"). Alles steht dort, BEVOR der Preis fällt. */
    kunstFensterTitel: "Your sheet",
    kunstFotoTauschen: "Change photo",
    kunstFeldTitel: "The big line — your name",
    kunstFeldSatz: "The sentence below",
    kunstFeldMail: "Your email",
    kunstMailWarum: "So we can send you the finished sheet. Optional.",
    kunstMailBetreff: "Your poster is ready",
    kunstMailText: "Here is your sheet. Download it any time from the page \u2014 or order it printed.",
    kunstAbPreis: "from {preis}",
    kunstSchritt1: "1 · Pick a photo of yourself",
    kunstSchritt2: "2 · Now press — we draw it",
    kunstKnopf: "You as a picture",
    kunstErzeugen: "Generate art · {preis}",
    kunstErzeugenKari: "Generate caricature · {preis}",
    kunstWartet: "Drawing…",
    /* ── NACH DEM LAUF GEHT ES WEITER (Owner 19.09.2026: „jetzt kann ich den Namen nicht mehr
       ändern im Poster") ─────────────────────────────────────────────────────────────────────
       Das Blatt ist bezahlt und da — der Knopf darf nicht weiter „erzeuge für 10 €" heissen.
       Ab hier öffnet er dasselbe Fenster, nur zum Schreiben: Titel und Satz, ohne neuen Lauf. */
    kunstDateiPdf: "PDF for a print shop",
    kunstTexteKnopf: "Change the words",
    kunstSpeichern: "Save",
    kunstGespeichert: "Saved.",
    tabDigital: "Digital Art",
    tabTextDigital: "Made on a screen, not on canvas — and just as much someone's own hand.",
    rubrikKariKicker: "New",
  ...
  ro: {
    ...
    filmTitel: "Povestea din spatele lucrării — videoul tău",
    filmErklaerung: "Stai lângă lucrare și spune-i povestea, cam un minut. Apare ca folie proprie la acest poster și în spatele codului QR.",
    wandFilmTitel: "Posterul pe un perete — video",
    wandFilmErklaerung: "Un clip scurt în care posterul este despachetat sau agățat. Apare ca folie lângă camere.",
    filmWaehlen: "Alege videoul", filmErsetzen: "Înlocuiește videoul", filmSpeichern: "Salvează videoul", filmAbbrechen: "Renunță",
    filmLoeschen: "Șterge videoul", filmLaedt: "Se încarcă …", filmGespeichert: "Salvat — videoul este pe posterul tău.",
    filmFehler: "Nu a mers. Te rugăm să încerci din nou.", filmZuGross: "Videoul este prea mare (max. 80 MB, cam un minut).",
    filmNurVideo: "Te rugăm să alegi un fișier video.",
    ...
    stimmeSkriptAnfang: "Mă numesc {name}.",
    stimmeSkriptHinweis: "O propunere — corectează-o și salveaz-o. Vorbește cu cuvintele tale; înregistrarea ești tu, nu un text.",
    ...
    grundSchief: "Lucrarea este fotografiată strâmb",
    grundUmgebung: "Se vede mai mult din cameră decât din lucrare",
    grundUnscharf: "Poza este neclară sau prea întunecată",
    grundSpiegelung: "Reflexii sau blitz pe lucrare",
    grundRahmen: "Ramă, mâini sau mobilă în poză",
    grundPasst: "Nu se potrivește portalului nostru",
    standLeer: "Aici nu este încă nicio poză — încarcă una",
    standFrei: "Publicată",
    standPruefung: "Încă neaprobată — ne uităm la ea",
    standAbgelehnt: "Neaprobată — te rugăm să înlocuiești poza",
    freistellen: "Decupează doar lucrarea",
    freistellenLaeuft: "Caut marginile…",
    freistellenZurueck: "Înapoi la original",
    freistellenNichts: "Marginile lucrării nu au putut fi găsite.",
    zumDashboard: "Dashboard",
    ...
    posterPreisWort: "Preț poster (A3, fără ramă), €",
    posterPreisPlatzhalter: "ex. 89 — gol = preț standard",
    ...
    druckVerkaufEigenes: "Aceasta e imaginea ta pe foaia noastră — nu e nimic al artistului pe ea, deci nu plătești licență. Plătești doar tiparul.",
    ...
    rubrikEinsTitel: "Living Poster",
    rubrikEinsText: "Un poster tipărit — până îl scanezi. Atunci telefonul pornește muzica și îți spune povestea lucrării.",
    rubrikEinsLink: "Descoperă posterele",
    rubrikZweiKicker: "Marii maeștri",
    rubrikZweiTitel: "Van Gogh, Klimt, Vermeer și alții",
    rubrikZweiText: "Lucrări intrate în domeniul public, tipărite la comandă pe hârtie adevărată — iar chipul tău poate intra în una dintre ele.",
    rubrikZweiLink: "Descoperă maeștrii",
    ...
    seiteWeiter: "Înainte",
    blattName: "Numele tău de artist — apare mare pe fiecare lucrare fără titlu propriu.",
    blattFelder: "Pe poster: titlul apare mare, numele tău și anul mic dedesubt.",
    kunstDateiFrei: "Gratuit",
    kunstZahlungAus: "Plata nu este disponibilă acum.",
    kunstZahlungDa: "Plata a intrat — apasă din nou butonul.",
    kunstZahlungWartet: "Confirmăm plata…",
    kunstZahlungWeg: "Nu ne-a ajuns nicio plată. Apasă butonul ca să încerci din nou.",
    kunstWerkGesperrt: "Această lucrare nu poate fi folosită.",
    kunstFotoAbgelehnt: "Poza nu merge — încearcă alta.",
    kunstNichtHier: "Nu este disponibil pentru această lucrare.",
    kunstFehlgeschlagen: "Nu a mers — mai încearcă o dată.",
    kunstNurBilder: "Doar JPG, PNG sau WebP.",
    kunstZuGross: "Maximum 20 MB.",
    kunstFensterTitel: "Lucrarea ta",
    kunstFotoTauschen: "Schimb\u0103 poza",
    kunstFeldTitel: "R\u00e2ndul mare \u2014 numele t\u0103u",
    kunstFeldSatz: "Frazele de dedesubt",
    kunstFeldMail: "E-mailul t\u0103u",
    kunstMailWarum: "Ca s\u0103-\u021bi trimitem lucrarea gata f\u0103cut\u0103. Op\u021bional.",
    kunstMailBetreff: "Posterul t\u0103u e gata",
    kunstMailText: "Aici e lucrarea ta. O po\u021bi desc\u0103rca oric\u00e2nd de pe pagin\u0103 \u2014 sau o comanzi tip\u0103rit\u0103.",
    kunstAbPreis: "de la {preis}",
    kunstSchritt1: "1 · Alege o poză cu tine",
    kunstSchritt2: "2 · Apasă acum — o desenăm",
    kunstKnopf: "Tu, ca tablou",
    kunstErzeugen: "Generează arta · {preis}",
    kunstErzeugenKari: "Generează caricatura · {preis}",
    kunstWartet: "Se desenează…",
    kunstDateiPdf: "PDF pentru tipografie",
    kunstTexteKnopf: "Schimbă textele",
    kunstSpeichern: "Salvează",
    kunstGespeichert: "Salvat.",
    tabDigital: "Digital Art",
    tabTextDigital: "Făcută pe ecran, nu pe pânză — și tot mâna cuiva e în ea.",
    rubrikKariKicker: "Nou",
  ...
  de: {
    ...
    filmTitel: "Die Geschichte hinter diesem Werk — dein Video",
    filmErklaerung: "Stell dich neben das Werk und erzähl seine Geschichte, etwa eine Minute. Es erscheint als eigene Folie an diesem Poster und hinter dem QR-Code.",
    wandFilmTitel: "Dieses Poster an einer Wand — Video",
    wandFilmErklaerung: "Ein kurzer Clip, in dem das Poster ausgepackt oder aufgehängt wird. Erscheint als Folie neben den Zimmern.",
    filmWaehlen: "Video wählen", filmErsetzen: "Video ersetzen", filmSpeichern: "Video speichern", filmAbbrechen: "Abbrechen",
    filmLoeschen: "Video löschen", filmLaedt: "Wird hochgeladen …", filmGespeichert: "Gespeichert — das Video hängt an deinem Poster.",
    filmFehler: "Das hat nicht geklappt. Bitte versuch es noch einmal.", filmZuGross: "Das Video ist zu gross (max. 80 MB, etwa eine Minute).",
    filmNurVideo: "Bitte wähle eine Videodatei.",
    ...
    stimmeSkriptAnfang: "Ich heisse {name}.",
    stimmeSkriptHinweis: "Ein Vorschlag — korrigier ihn und speichere. Sprich in deinen Worten; die Aufnahme bist du, nicht ein Text.",
    ...
    standLeer: "Hier ist noch kein Bild — lade eines hoch",
    standFrei: "Veröffentlicht",
    standPruefung: "Noch nicht freigegeben — wir sehen es uns an",
    standAbgelehnt: "Nicht freigegeben — bitte tausche dieses Bild",
    freistellen: "Kunst freistellen",
    freistellenLaeuft: "Ränder suchen…",
    freistellenZurueck: "Zurück zum Original",
    freistellenNichts: "Die Ränder des Werks waren nicht zu finden.",
    zumDashboard: "Dashboard",
    ...
    posterPreisWort: "Posterpreis (A3, ohne Rahmen), €",
    posterPreisPlatzhalter: "z. B. 89 — leer = Standardpreis",
    ...
    druckVerkaufEigenes: "Das ist dein eigenes Bild auf unserem Blatt — vom Künstler ist nichts darauf, also zahlst du keine Lizenz. Du zahlst nur den Druck.",
    ...
    rubrikEinsTitel: "Living Poster",
    rubrikEinsText: "Ein gedrucktes Poster — bis du es scannst. Dann spielt das Telefon die Musik und erzählt dir die Geschichte des Werks.",
    rubrikEinsLink: "Poster entdecken",
    rubrikZweiKicker: "Alte Meister",
    rubrikZweiTitel: "Van Gogh, Klimt, Vermeer und mehr",
    rubrikZweiText: "Gemeinfreie Werke, auf Bestellung auf echtem Papier gedruckt — und dein eigenes Gesicht kann in eines davon hinein.",
    rubrikZweiLink: "Meister entdecken",
    ...
    seiteWeiter: "Weiter",
    blattName: "Dein Künstlername — steht gross auf jedem Blatt, das keinen eigenen Titel hat.",
    blattFelder: "Auf dem Blatt: der Titel steht gross, dein Name und das Jahr klein darunter.",
    kunstDateiFrei: "Gratis",
    kunstZahlungAus: "Die Kasse ist gerade nicht erreichbar.",
    kunstZahlungDa: "Zahlung ist da — drück den Knopf noch einmal.",
    kunstZahlungWartet: "Zahlung wird bestätigt…",
    kunstZahlungWeg: "Bei uns ist keine Zahlung angekommen. Drück den Knopf, um es noch einmal zu versuchen.",
    kunstWerkGesperrt: "Dieses Werk lässt sich nicht verwenden.",
    kunstFotoAbgelehnt: "Geht nicht — nimm ein anderes Foto.",
    kunstNichtHier: "Für dieses Werk gibt es das nicht.",
    kunstFehlgeschlagen: "Hat nicht geklappt — versuch es noch einmal.",
    kunstNurBilder: "Nur JPG, PNG oder WebP.",
    kunstZuGross: "Höchstens 20 MB.",
    kunstFensterTitel: "Dein Blatt",
    kunstFotoTauschen: "Foto tauschen",
    kunstFeldTitel: "Die grosse Zeile \u2014 dein Name",
    kunstFeldSatz: "Der Satz darunter",
    kunstFeldMail: "Deine E-Mail",
    kunstMailWarum: "Damit wir dir das fertige Blatt schicken k\u00f6nnen. Freiwillig.",
    kunstMailBetreff: "Dein Poster ist fertig",
    kunstMailText: "Hier ist dein Blatt. Du kannst es jederzeit von der Seite laden \u2014 oder gedruckt bestellen.",
    kunstAbPreis: "ab {preis}",
    kunstSchritt1: "1 · Wähl ein Foto von dir",
    kunstSchritt2: "2 · Jetzt drücken — wir zeichnen es",
    kunstKnopf: "Du als Bild",
    kunstErzeugen: "Kunst erzeugen · {preis}",
    kunstErzeugenKari: "Karikatur erzeugen · {preis}",
    kunstWartet: "Wird gezeichnet…",
    kunstDateiPdf: "PDF für die Druckerei",
    kunstTexteKnopf: "Texte ändern",
    kunstSpeichern: "Speichern",
    kunstGespeichert: "Gespeichert.",
    tabDigital: "Digital Art",
    tabTextDigital: "Am Bildschirm entstanden, nicht auf Leinwand — und trotzdem die Hand eines Menschen.",
    rubrikKariKicker: "Neu",
