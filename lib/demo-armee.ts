...
export const RECRUITER_DE = {
  ...
  uebergabe: "Übergabe:",
  uebergabeText: "Export der Liste sofort; eine Schnittstelle in Ihr System bauen wir, sobald der Pilot läuft.",
  speicherort: "Speicherort:",
  speicherortText: "Rechenzentrum Frankfurt am Main, Deutschland.",
  nachweise: "Nachweise:",
  nachweiseText: "ISO 27001 und SOC 2 Type 2 des Betreibers, Auftragsverarbeitungsvertrag mit EU-Standardvertragsklauseln.",
...
export const RECRUITER_EN: RecruiterTexte = {
  ...
  uebergabe: "Handover:",
  uebergabeText: "Export of the list right away; an interface into your system once the pilot is running.",
  speicherort: "Location:",
  speicherortText: "Data centre in Frankfurt am Main, Germany.",
  nachweise: "Certifications:",
  nachweiseText: "ISO 27001 and SOC 2 Type 2 of the operator, data processing agreement with EU standard contractual clauses.",
