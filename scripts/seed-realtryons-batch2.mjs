...
const NEW_CURATORS = [
  { photo: "6.jpg",  firstName: "Elina",  lastName: "Petrova",  email: "elina.petrova@seed.lb",  motto: "Black is a colour", instagram: "elina.petrova", style: "City glam, sleek tailoring", brands: "Saint Laurent, Mugler, The Attico", colors: "black, gold", occasions: "party, evening", priceTiers: "Mid-range, Luxury", bio: "Rooftops, black dresses, late nights. That's the whole brand." },
  { photo: "7.jpg",  firstName: "Carla",  lastName: "Moreno",   email: "carla.moreno@seed.lb",   motto: "Effortless, on purpose", instagram: "carla.moreno", style: "Mediterranean chic, soft tailoring", brands: "Mango, Massimo Dutti, Reformation", colors: "ivory, tan, terracotta", occasions: "brunch, weekend", priceTiers: "Budget, Mid-range", bio: "Easy pieces that look like you tried — without trying." },
  { photo: "8.jpg",  firstName: "Yasmin", lastName: "Haddad",   email: "yasmin.haddad@seed.lb",  motto: "Drama, tastefully", instagram: "yasmin.haddad", style: "Statement gowns, bold cuts", brands: "Elie Saab, Zuhair Murad, Roberto Cavalli", colors: "emerald, wine, gold", occasions: "gala, event", priceTiers: "Luxury", bio: "If it doesn't make an entrance, I'm not interested." },
  { photo: "9.jpg",  firstName: "Nadia",  lastName: "Rossi",    email: "nadia.rossi@seed.lb",    motto: "Italian, obviously", instagram: "nadia.rossi", style: "Milano polish, prints & tailoring", brands: "Dolce & Gabbana, Versace, Etro", colors: "red, black, floral", occasions: "date, dinner", priceTiers: "Mid-range, Luxury", bio: "Grew up between Milano and the sea. It shows in everything I pick." },
  { photo: "10.jpg", firstName: "Tessa",  lastName: "Lindqvist", email: "tessa.lindqvist@seed.lb", motto: "Cool, clean, done", instagram: "tessa.lindqvist", style: "Scandi minimal with an edge", brands: "Toteme, Acne Studios, Khaite", colors: "white, grey, camel", occasions: "work, everyday", priceTiers: "Mid-range, Luxury", bio: "One sharp piece beats a closet of maybes." },
];
