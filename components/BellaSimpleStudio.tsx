...
export default function BellaSimpleStudio() {
  ...
  return (
    <div className="rounded-2xl border border-white/15 bg-white/[0.04] p-4">
      ...
      <p className="mt-0.5 text-[12px] font-semibold text-white/60">Bild oder Video hochladen, Text dazuschreiben. Sofort oben auf der Seite.</p>
            ...
            <div key={p.id} className="flex gap-3 rounded-xl border border-white/10 bg-black/30 p-2">
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-1.5">
                ...
                <div className="mt-1.5 flex items-center gap-2">
                  {savingId === p.id ? <span className="text-[11px] font-bold text-white/50">speichert…</span>
                    : savedId === p.id ? <span className="flex items-center gap-1 text-[11px] font-black text-emerald-400"><Check className="h-3 w-3" /> gespeichert</span>
                    : <span className="text-[11px] font-bold text-white/35">Text wird beim Verlassen gespeichert</span>}
