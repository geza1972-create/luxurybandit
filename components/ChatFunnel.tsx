...
const LOOKS_INCLUDED = 10;     // Videos/Generierungen pro Monat im Abo — themenuebergreifend
...
const UI: Record<string, {
  ...
  en: { s1: "1 · Choose her", s1p: "Swipe our models — or upload a photo of the woman you have in mind.", own: "Your own", ownHint: "Upload one photo — she becomes your AI girl.", nameHer: "Give her a name",
        s2: "2 · Talk to her", s3: "3 · Dress her", incl: "10 videos & looks a month are included — across all topics.", left: "left this month (all topics together) — every extra one is 3.99 €.",
  ...
  de: { s1: "1 · Wähle sie", s1p: "Wisch durch unsere Models — oder lade ein Foto der Frau hoch, die du im Kopf hast.", own: "Deine eigene", ownHint: "Ein Foto hochladen — sie wird deine KI-Frau.", nameHer: "Gib ihr einen Namen",
        s2: "2 · Schreib mit ihr", s3: "3 · Zieh sie an", incl: "10 Videos & Looks im Monat sind enthalten — über alle Themen.", left: "übrig diesen Monat (alle Themen zusammen) — jedes weitere 3,99 €.",
  ...
  ro: { s1: "1 · Alege-o", s1p: "Glisează prin modelele noastre — sau încarcă poza femeii la care te gândești.", own: "A ta", ownHint: "Încarcă o poză — devine fata ta AI.", nameHer: "Dă-i un nume",
        s2: "2 · Scrie-i", s3: "3 · Îmbrac-o", incl: "10 videoclipuri și ținute pe lună sunt incluse — în toate temele.", left: "rămase luna aceasta (toate temele) — fiecare în plus 3,99 €.",
  ...
  es: { s1: "1 · Elígela", s1p: "Desliza por nuestras modelos — o sube una foto de la mujer que tienes en mente.", own: "La tuya", ownHint: "Sube una foto — será tu chica IA.", nameHer: "Ponle un nombre",
        s2: "2 · Habla con ella", s3: "3 · Vístela", incl: "10 vídeos y looks al mes están incluidos — en todos los temas.", left: "restantes este mes (todos los temas) — cada extra 3,99 €.",
  ...
  fr: { s1: "1 · Choisis-la", s1p: "Fais défiler nos modèles — ou charge la photo de la femme que tu imagines.", own: "La tienne", ownHint: "Charge une photo — elle devient ta fille IA.", nameHer: "Donne-lui un prénom",
        s2: "2 · Parle avec elle", s3: "3 · Habille-la", incl: "10 vidéos et looks par mois sont inclus — sur tous les thèmes.", left: "restants ce mois-ci (tous thèmes) — chaque extra 3,99 €.",
  ...
  pt: { s1: "1 · Escolhe-a", s1p: "Desliza pelas nossas modelos — ou carrega a foto da mulher em que pensas.", own: "A tua", ownHint: "Carrega uma foto — passa a ser a tua rapariga IA.", nameHer: "Dá-lhe um nome",
        s2: "2 · Fala com ela", s3: "3 · Veste-a", incl: "10 vídeos e looks por mês estão incluídos — em todos os temas.", left: "restantes este mês (todos os temas) — cada extra 3,99 €.",
  ...
  pl: { s1: "1 · Wybierz ją", s1p: "Przesuwaj nasze modelki — albo wgraj zdjęcie kobiety, o której myślisz.", own: "Twoja własna", ownHint: "Wgraj jedno zdjęcie — zostanie Twoją dziewczyną AI.", nameHer: "Nadaj jej imię",
        s2: "2 · Napisz do niej", s3: "3 · Ubierz ją", incl: "10 filmów i stylizacji miesięcznie w cenie — we wszystkich tematach.", left: "pozostało w tym miesiącu (wszystkie tematy) — każda kolejna 3,99 €.",
        ...
        <div className="border-t border-black/10 px-3 py-2.5">
          {dayFull ? (
            ...
            <div className="text-center">
              ...
              <p className="mt-0.5 text-[12px] font-bold leading-snug text-black/60">24,50 € a month — every day, plus your 10 videos a month across all topics.</p>
