...
const TEXTE: Record<string, { titel: string; features: Feature[]; zugabe: string }> = {
  de: {
    ...
    features: [
      { t: "Deine Sprache sitzt noch nicht? Kein Problem.", d: "Wir geben dir den Text in der Sprache, die du fürs Video wählst — du liest ihn nur ab. Oder du sprichst in deiner Sprache: Englisch, Rumänisch, wie du willst. Deine Entscheidung. Und die Texte deines Lebenslaufs werden automatisch in drei Sprachen übersetzt." },
      { t: "Was du für dein Geld bekommst.", d: "Eine eigene Webseite mit eigener Adresse — in drei Sprachen, mit deinem Video darin und einem Chat, über den Firmen dich erreichen. Du schickst sie an alle, oder alle Firmen sehen sie. Und sie schätzen das weit mehr als PDFs, die ihren Speicher vollmachen." },
  ...
  en: {
    ...
    features: [
      { t: "Your language isn't perfect? No problem.", d: "We give you the script in the language you choose for the video — you just read it out. Or you speak in your own language: English, Romanian, whatever suits you. Your choice. And the texts in your CV are translated automatically into three languages." },
      { t: "What you get for your money.", d: "Your own web page with its own address — in three languages, with your video in it and a chat companies use to reach you. Send it to everyone, or let every company see it. And they appreciate that far more than PDFs filling up their storage." },
  ...
  ro: {
    ...
    features: [
      { t: "Nu știi limba bine? Nu-i o problemă.", d: "Îți dăm textul în limba pe care o alegi pentru video — tu doar îl citești. Sau vorbești în limba ta: engleză, română, cum vrei tu. E alegerea ta. Iar textele din CV-ul tău se traduc automat în trei limbi." },
      { t: "Ce primești de banii tăi.", d: "O pagină web proprie, cu adresa ta — în trei limbi, cu videoul tău în ea și un chat prin care firmele te contactează. O trimiți la toți, sau o văd toate firmele. Iar ele apreciază asta mult mai mult decât PDF-uri care le încarcă memoria." },
  ...
  es: {
    ...
    features: [
      { t: "¿Tu idioma no es perfecto? No es problema.", d: "Te damos el texto en el idioma que elijas para el vídeo — tú solo lo lees. O hablas en tu idioma: inglés, rumano, el que quieras. Tú decides. Y los textos de tu currículum se traducen automáticamente a tres idiomas." },
      { t: "Qué recibes por tu dinero.", d: "Tu propia página web con su dirección — en tres idiomas, con tu vídeo dentro y un chat con el que las empresas te contactan. La envías a todos, o la ven todas las empresas. Y lo aprecian mucho más que PDF que les llenan la memoria." },
  ...
  fr: {
    ...
    features: [
      { t: "Ta langue n'est pas encore parfaite ? Aucun problème.", d: "On te donne le texte dans la langue que tu choisis pour la vidéo — tu n'as qu'à le lire. Ou tu parles dans ta langue : anglais, roumain, comme tu veux. C'est ton choix. Et les textes de ton CV sont traduits automatiquement en trois langues." },
      { t: "Ce que tu reçois pour ton argent.", d: "Ta propre page web avec sa propre adresse — en trois langues, avec ta vidéo dedans et un chat par lequel les entreprises te joignent. Tu l'envoies à tous, ou toutes les entreprises la voient. Et elles apprécient ça bien plus que des PDF qui remplissent leur mémoire." },
  ...
  pt: {
    ...
    features: [
      { t: "A tua língua ainda não está perfeita? Sem problema.", d: "Damos-te o texto na língua que escolheres para o vídeo — só tens de o ler. Ou falas na tua língua: inglês, romeno, como quiseres. A escolha é tua. E os textos do teu CV são traduzidos automaticamente para três línguas." },
      { t: "O que recebes pelo teu dinheiro.", d: "Uma página web própria, com o teu endereço — em três línguas, com o teu vídeo lá dentro e um chat através do qual as empresas te contactam. Envia-la a todos, ou todas as empresas a veem. E elas apreciam isso muito mais do que PDF que lhes enchem a memória." },
  ...
  it: {
    ...
    features: [
      { t: "La tua lingua non è ancora perfetta? Nessun problema.", d: "Ti diamo il testo nella lingua che scegli per il video — devi solo leggerlo. Oppure parli nella tua lingua: inglese, rumeno, come vuoi. La scelta è tua. E i testi del tuo CV vengono tradotti automaticamente in tre lingue." },
      { t: "Cosa ricevi per i tuoi soldi.", d: "Una pagina web tua, con il tuo indirizzo — in tre lingue, con il tuo video dentro e una chat con cui le aziende ti raggiungono. La mandi a tutti, o la vedono tutte le aziende. E lo apprezzano molto più dei PDF che riempiono la loro memoria." },
