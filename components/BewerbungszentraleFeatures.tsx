...
const TEXTE: Record<string, { titel: string; features: Feature[]; zugabe: string }> = {
  de: {
    ...
    features: [
      ...
      { t: "Was du für dein Geld bekommst.", d: "Eine eigene Webseite mit eigener Adresse — in sieben Sprachen, mit deinem Video darin und einem Chat, über den Firmen dich erreichen. Du schickst sie an alle, oder alle Firmen sehen sie. Und sie schätzen das weit mehr als PDFs, die ihren Speicher vollmachen." },
  ...
  en: {
    ...
    features: [
      ...
      { t: "What you get for your money.", d: "Your own web page with its own address — in seven languages, with your video in it and a chat companies use to reach you. Send it to everyone, or let every company see it. And they appreciate that far more than PDFs filling up their storage." },
  ...
  ro: {
    ...
    features: [
      ...
      { t: "Ce primești de banii tăi.", d: "O pagină web proprie, cu adresa ta — în șapte limbi, cu videoul tău în ea și un chat prin care firmele te contactează. O trimiți la toți, sau o văd toate firmele. Iar ele apreciază asta mult mai mult decât PDF-uri care le încarcă memoria." },
  ...
  es: {
    ...
    features: [
      ...
      { t: "Qué recibes por tu dinero.", d: "Tu propia página web con su dirección — en siete idiomas, con tu vídeo dentro y un chat con el que las empresas te contactan. La envías a todos, o la ven todas las empresas. Y lo aprecian mucho más que PDF que les llenan la memoria." },
  ...
  fr: {
    ...
    features: [
      ...
      { t: "Ce que tu reçois pour ton argent.", d: "Ta propre page web avec sa propre adresse — en sept langues, avec ta vidéo dedans et un chat par lequel les entreprises te joignent. Tu l'envoies à tous, ou toutes les entreprises la voient. Et elles apprécient ça bien plus que des PDF qui remplissent leur mémoire." },
  ...
  pt: {
    ...
    features: [
      ...
      { t: "O que recebes pelo teu dinheiro.", d: "Uma página web própria, com o teu endereço — em sete línguas, com o teu vídeo lá dentro e um chat através do qual as empresas te contactam. Envia-la a todos, ou todas as empresas a veem. E elas apreciam isso muito mais do que PDF que lhes enchem a memória." },
  ...
  it: {
    ...
    features: [
      ...
      { t: "Cosa ricevi per i tuoi soldi.", d: "Una pagina web tua, con il tuo indirizzo — in sette lingue, con il tuo video dentro e una chat con cui le aziende ti raggiungono. La mandi a tutti, o la vedono tutte le aziende. E lo apprezzano molto più dei PDF che riempiono la loro memoria." },
