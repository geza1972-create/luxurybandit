...
const T: Record<string, {
  head: string; sub: string; head2: string; sub2: string; name: string; birth: string; g: Record<"m" | "f" | "x", string>;
  city: string; phone: string; save: string; done: string;
  stop: string; stopSure: string; stopped: string;
}> = {
  en: { head: "Where should the weather come from?", sub: "Tell me your city and I'll send the weather where you actually are. Your number stays private — it is only used for the region and language.", head2: "Two more things", sub2: "So the daily post fits you: your birthday and how we should address you.", name: "Your name", birth: "Your date of birth", g: { m: "Male", f: "Female", x: "Other" }, city: "Your city", phone: "Phone with country code (+40 …)", save: "Save", done: "Saved — tomorrow it fits you.", stop: "Stop the daily mail", stopSure: "Tap again to unsubscribe", stopped: "Unsubscribed. No more daily mail." },
  de: { head: "Woher soll das Wetter kommen?", sub: "Sag mir deine Stadt, dann schicke ich dir das Wetter, wo du wirklich bist. Deine Nummer bleibt privat — sie dient nur der Region und der Sprache.", head2: "Noch zwei Angaben", sub2: "Damit die Tagespost zu dir passt: dein Geburtstag und wie wir dich ansprechen sollen.", name: "Dein Name", birth: "Dein Geburtsdatum", g: { m: "Männlich", f: "Weiblich", x: "Divers" }, city: "Deine Stadt", phone: "Telefon mit Vorwahl (+49 …)", save: "Speichern", done: "Gespeichert — morgen passt es zu dir.", stop: "Tagespost abbestellen", stopSure: "Nochmal tippen zum Abmelden", stopped: "Abgemeldet. Keine Tagespost mehr." },
  ro: { head: "De unde să vină vremea?", sub: "Spune-mi orașul tău și îți trimit vremea de unde ești cu adevărat. Numărul rămâne privat — folosit doar pentru regiune și limbă.", head2: "Încă două detalii", sub2: "Ca mesajul zilnic să ți se potrivească: ziua ta de naștere și cum să ți ne adresăm.", name: "Numele tău", birth: "Data nașterii", g: { m: "Bărbat", f: "Femeie", x: "Altul" }, city: "Orașul tău", phone: "Telefon cu prefix (+40 …)", save: "Salvează", done: "Salvat — mâine se potrivește.", stop: "Nu mai vreau mesajul zilnic", stopSure: "Apasă din nou pentru dezabonare", stopped: "Dezabonat. Nu mai primești mesaje." },
  es: { head: "¿De dónde debe venir el tiempo?", sub: "Dime tu ciudad y te envío el tiempo de donde estás. Tu número queda privado — solo para la región y el idioma.", head2: "Dos datos más", sub2: "Para que el mensaje diario encaje contigo: tu cumpleaños y cómo dirigirnos a ti.", name: "Tu nombre", birth: "Tu fecha de nacimiento", g: { m: "Hombre", f: "Mujer", x: "Otro" }, city: "Tu ciudad", phone: "Teléfono con prefijo (+34 …)", save: "Guardar", done: "Guardado — mañana encaja.", stop: "Dejar de recibir el correo diario", stopSure: "Pulsa otra vez para darte de baja", stopped: "Baja completada." },
  fr: { head: "D'où doit venir la météo ?", sub: "Dis-moi ta ville et je t'envoie la météo de là où tu es. Ton numéro reste privé — uniquement pour la région et la langue.", head2: "Encore deux détails", sub2: "Pour que le message quotidien te corresponde : ta date de naissance et comment t'appeler.", name: "Ton prénom", birth: "Ta date de naissance", g: { m: "Homme", f: "Femme", x: "Autre" }, city: "Ta ville", phone: "Téléphone avec indicatif (+33 …)", save: "Enregistrer", done: "Enregistré — demain ça colle.", stop: "Arrêter le message quotidien", stopSure: "Touche encore pour te désabonner", stopped: "Désabonné." },
  pt: { head: "De onde deve vir o tempo?", sub: "Diz-me a tua cidade e envio-te o tempo de onde estás. O número fica privado — só para região e idioma.", head2: "Mais dois detalhes", sub2: "Para a mensagem diária encaixar contigo: a tua data de nascimento e como te tratar.", name: "O teu nome", birth: "A tua data de nascimento", g: { m: "Homem", f: "Mulher", x: "Outro" }, city: "A tua cidade", phone: "Telefone com indicativo (+351 …)", save: "Guardar", done: "Guardado — amanhã encaixa.", stop: "Parar a mensagem diária", stopSure: "Toca outra vez para cancelar", stopped: "Cancelado." },
  pl: { head: "Skąd ma być pogoda?", sub: "Podaj miasto, a wyślę pogodę z miejsca, gdzie naprawdę jesteś. Numer zostaje prywatny — tylko region i język.", head2: "Jeszcze dwie rzeczy", sub2: "Żeby codzienna wiadomość pasowała do Ciebie: data urodzin i jak się do Ciebie zwracać.", name: "Twoje imię", birth: "Data urodzenia", g: { m: "Mężczyzna", f: "Kobieta", x: "Inne" }, city: "Twoje miasto", phone: "Telefon z kierunkowym (+48 …)", save: "Zapisz", done: "Zapisane — jutro będzie pasować.", stop: "Nie chcę codziennej wiadomości", stopSure: "Dotknij ponownie, aby zrezygnować", stopped: "Wypisano." },
  it: { head: "Da dove deve arrivare il meteo?", sub: "Dimmi la tua città e ti mando il meteo di dove sei. Il numero resta privato — solo per regione e lingua.", head2: "Ancora due dettagli", sub2: "Perché il messaggio quotidiano ti calzi: la tua data di nascita e come rivolgerci a te.", name: "Il tuo nome", birth: "La tua data di nascita", g: { m: "Uomo", f: "Donna", x: "Altro" }, city: "La tua città", phone: "Telefono con prefisso (+39 …)", save: "Salva", done: "Salvato — domani va bene.", stop: "Basta messaggio quotidiano", stopSure: "Tocca di nuovo per disiscriverti", stopped: "Disiscritto." },
};
  ...
  return (
    <div className="mt-4 rounded-2xl border border-white/20 bg-white/[0.06] p-4">
      <p className="flex items-center gap-2 text-[15px] font-black text-white">
        {/* Überschrift muss zu den GEZEIGTEN Feldern passen: fragen wir weder Stadt noch
            Nummer, ist „Woher soll das Wetter kommen?" schlicht falsch (Owner 28.07.2026). */}
        <MapPin className="h-4 w-4 text-[#f6cf51]" /> {(askCity || askPhone) ? t.head : t.head2}
      </p>
      <p className="mt-1 text-[13px] font-bold leading-snug text-white/75">{(askCity || askPhone) ? t.sub : t.sub2}</p>
