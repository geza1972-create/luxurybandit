...
const TEXTE: Record<string, { titel: string; zeile: string; cta: string; beispiel: string }> = {
  de: {
    ...
    zeile: "Genau so sieht deine fertige Bewerbungsseite aus — mit deinem Video, deinem Werdegang und den passenden Rollen. Sieh dir ein echtes Profil an, bevor du startest.",
    cta: "Beispielprofil ansehen",
    beispiel: "Beispiel",
  },
  ro: {
    titel: "Pagina pe care o primești",
    zeile: "Exact așa arată pagina ta de aplicare finală — videoclipul tău, parcursul tău și rolurile potrivite. Uită-te la un profil real înainte să începi.",
    cta: "Vezi profilul exemplu",
    beispiel: "Exemplu",
  },
  es: {
    titel: "La página que recibes",
    zeile: "Así es exactamente tu página de candidatura terminada — tu vídeo, tu trayectoria y los roles que encajan. Mira un perfil real antes de empezar.",
    cta: "Ver el perfil de ejemplo",
    beispiel: "Ejemplo",
  },
  fr: {
    titel: "La page que tu reçois",
    zeile: "Voilà exactement ta page de candidature terminée — ta vidéo, ton parcours et les rôles adaptés. Regarde un vrai profil avant de commencer.",
    cta: "Voir le profil exemple",
    beispiel: "Exemple",
  },
  pt: {
    titel: "A página que recebes",
    zeile: "É exatamente assim a tua página de candidatura final — o teu vídeo, o teu percurso e as funções adequadas. Vê um perfil real antes de começares.",
    cta: "Ver o perfil de exemplo",
    beispiel: "Exemplo",
  },
  it: {
    titel: "La pagina che ricevi",
    zeile: "La tua pagina di candidatura finita è esattamente così — il tuo video, il tuo percorso e i ruoli adatti. Guarda un profilo reale prima di iniziare.",
    cta: "Vedi il profilo di esempio",
    beispiel: "Esempio",
  },
  en: {
    titel: "The page you get",
    zeile: "This is exactly what your finished application page looks like — your video, your track record and the roles that fit. Look at a real profile before you start.",
