...
const T: Record<string, Copy> = {
  ro: {
    ...
    cta: "Creează cont", note: "Fără parolă. Îți confirmi emailul o singură dată.",
  ...
  de: {
    ...
    cta: "Account erstellen", note: "Ohne Passwort. E-Mail einmal bestätigen.",
  ...
  en: {
    ...
    cta: "Create account", note: "No password. Confirm your email once.",
