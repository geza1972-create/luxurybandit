      ...
      <div className="relative">
        ...
        {telefon && (
          demo ? (
            ...
            <a href={`https://wa.me/${telefon.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(`${sie} & ${er} 💍 `)}`} target="_blank" rel="noreferrer"
