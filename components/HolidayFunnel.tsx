  ...
  return (
    <div className="mt-8">
      ...
      <p className="mt-2 text-[13px] font-bold leading-snug text-white/75">
        {aboPaid ? "Every extra video is 3.99 €." : "The first one starts your topic subscription: 8 € the first month, then 49 € — every extra video after that is 3.99 €."}
      </p>
              ...
              <div className="absolute inset-0 grid place-items-center bg-black/30">
                <div className="px-6 text-center">
                  ...
                  <button type="button" onClick={() => void unlock()} disabled={payBusy}
                    ...
                    {isStaff ? "Reveal (Admin — free)" : aboPaid ? "Unlock — €3.99" : "Unlock — 8 € first month"}
                  </button>
