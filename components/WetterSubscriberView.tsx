...
export default function WetterSubscriberView({ name, city, look, lang = DEFAULT_LANG, modelId = DEFAULT_MODEL_ID, modelName = "Bella", subId = "", day = "", time = "" }: {
  ...
  return (
    <div className="mx-auto max-w-md px-4">
      ...
      {/* Look vom Tag */}
      {look && (
        <div className="lb-theme relative mt-4 aspect-[3/4] w-full overflow-hidden rounded-2xl border-2 border-[#c9a23f] bg-black">
          {look.kind === "video" ? (
            <>
      ...
      {/* Chat mit dem Model */}
      <div className="lb-theme mb-8 mt-6 rounded-2xl border-2 border-[#c9a23f] bg-white/[0.03]">
