    ...
    <div className="mx-auto max-w-md">
      ...
      {!paid && (() => {
        const S: Record<string, { h: string; p: string; cta: string; ctaCode: string }> = {
          ro: { h: "Toate modelele, toate temele", p: "Orice model, orice ținută, orice temă: 25 de videoclipuri pe lună — chatul rămâne gratuit.", cta: "Deblochează cea mai fierbinte experiență AI — 24,50 €/lună", ctaCode: "Deblochează cea mai fierbinte experiență AI — 24,50 €/lună" },
          de: { h: "Alle Models, alle Themen", p: "Jedes Model, jeder Look, jedes Thema: 25 Videos im Monat — Chatten bleibt gratis.", cta: "Die heißeste KI-Erfahrung freischalten — 24,50 €/Monat", ctaCode: "Die heißeste KI-Erfahrung freischalten — 24,50 €/Monat" },
          en: { h: "Every model, every topic", p: "Every model, every look, every topic: 25 videos a month — chatting stays free.", cta: "Unlock the hottest AI experience ever — €24.50/month", ctaCode: "Unlock the hottest AI experience ever — €24.50/month" },
          es: { h: "Todas las modelos, todos los temas", p: "Cualquier modelo, cualquier look, cualquier tema: 25 vídeos al mes — chatear sigue gratis.", cta: "Desbloquea la experiencia IA más ardiente — 24,50 €/mes", ctaCode: "Desbloquea la experiencia IA más ardiente — 24,50 €/mes" },
          fr: { h: "Toutes les modèles, tous les thèmes", p: "N'importe quelle modèle, n'importe quelle tenue, n'importe quel thème : 25 vidéos par mois — le chat reste gratuit.", cta: "Débloque l'expérience IA la plus chaude — 24,50 €/mois", ctaCode: "Débloque l'expérience IA la plus chaude — 24,50 €/mois" },
          pt: { h: "Todas as modelos, todos os temas", p: "Qualquer modelo, qualquer look, qualquer tema: 25 vídeos por mês — conversar continua grátis.", cta: "Desbloqueia a experiência de IA mais quente — 24,50 €/mês", ctaCode: "Desbloqueia a experiência de IA mais quente — 24,50 €/mês" },
          pl: { h: "Wszystkie modelki, wszystkie tematy", p: "Dowolna modelka, dowolna stylizacja, dowolny temat: 25 filmów miesięcznie — czat pozostaje darmowy.", cta: "Odblokuj najgorętsze doświadczenie AI — 24,50 €/miesiąc", ctaCode: "Odblokuj najgorętsze doświadczenie AI — 24,50 €/miesiąc" },
          it: { h: "Tutte le modelle, tutti i temi", p: "Qualsiasi modella, qualsiasi look, qualsiasi tema: 25 video al mese — chattare resta gratis.", cta: "Sblocca l'esperienza AI più calda — 24,50 €/mese", ctaCode: "Sblocca l'esperienza AI più calda — 24,50 €/mese" },
        };
        const x = S[L] ?? S.en;
        return (
      ...
      {(() => {
        const P: Record<string, { h: string; sub: string; inAbo: string; items: [string, string, string][] }> = {
          ro: { h: "Descoperă ceva nou \u2728", sub: "25 de videoclipuri pe lună, 24,50 €. Chatul e gratuit.", inAbo: "Continuă", items: [
          ...
          de: { h: "Entdecke Neues \u2728", sub: "25 Videos im Monat, 24,50 €. Chatten ist gratis.", inAbo: "Weiter", items: [
          ...
          en: { h: "Discover something new \u2728", sub: "25 videos a month, €24.50. Chatting is free.", inAbo: "Continue", items: [
          ...
          es: { h: "Descubre algo nuevo \u2728", sub: "25 vídeos al mes, 24,50 €. Chatear es gratis.", inAbo: "Continuar", items: [
          ...
          fr: { h: "Découvre du nouveau \u2728", sub: "25 vidéos par mois, 24,50 €. Le chat est gratuit.", inAbo: "Continuer", items: [
          ...
          pt: { h: "Descobre algo novo \u2728", sub: "25 vídeos por mês, 24,50 €. Conversar é grátis.", inAbo: "Continuar", items: [
          ...
          pl: { h: "Odkryj coś nowego \u2728", sub: "25 filmów miesięcznie, 24,50 €. Czat jest darmowy.", inAbo: "Dalej", items: [
          ...
          it: { h: "Scopri qualcosa di nuovo \u2728", sub: "25 video al mese, 24,50 €. Chattare è gratis.", inAbo: "Continua", items: [
