    ...
    <div className="mx-auto max-w-md">
      ...
      {!paid && (() => {
        const S: Record<string, { h: string; p: string; cta: string; ctaCode: string }> = {
          ro: { h: "Toate modelele, toate temele", p: "Orice model, orice ținută, orice temă — videoclipuri cu ea, și cu tine în ele. Chatul rămâne gratuit.", cta: "Deblochează cea mai fierbinte experiență AI — {price}/lună", ctaCode: "Deblochează cea mai fierbinte experiență AI — {price}/lună" },
          de: { h: "Alle Models, alle Themen", p: "Jedes Model, jeder Look, jedes Thema — Videos mit ihr, und du mit im Bild. Chatten bleibt gratis.", cta: "Die heißeste KI-Erfahrung freischalten — {price}/Monat", ctaCode: "Die heißeste KI-Erfahrung freischalten — {price}/Monat" },
          en: { h: "Every model, every topic", p: "Every model, every look, every topic — videos with her, and you in them. Chatting stays free.", cta: "Unlock the hottest AI experience ever — {price}/month", ctaCode: "Unlock the hottest AI experience ever — {price}/month" },
          es: { h: "Todas las modelos, todos los temas", p: "Cualquier modelo, cualquier look, cualquier tema — vídeos con ella, y tú en ellos. Chatear sigue gratis.", cta: "Desbloquea la experiencia IA más ardiente — {price}/mes", ctaCode: "Desbloquea la experiencia IA más ardiente — {price}/mes" },
          fr: { h: "Toutes les modèles, tous les thèmes", p: "N'importe quelle modèle, n'importe quelle tenue, n'importe quel thème — des vidéos avec elle, et toi dedans. Le chat reste gratuit.", cta: "Débloque l'expérience IA la plus chaude — {price}/mois", ctaCode: "Débloque l'expérience IA la plus chaude — {price}/mois" },
          pt: { h: "Todas as modelos, todos os temas", p: "Qualquer modelo, qualquer look, qualquer tema — vídeos com ela, e tu neles. Conversar continua grátis.", cta: "Desbloqueia a experiência de IA mais quente — {price}/mês", ctaCode: "Desbloqueia a experiência de IA mais quente — {price}/mês" },
          pl: { h: "Wszystkie modelki, wszystkie tematy", p: "Dowolna modelka, dowolna stylizacja, dowolny temat — filmy z nią, i z tobą w kadrze. Czat pozostaje darmowy.", cta: "Odblokuj najgorętsze doświadczenie AI — {price}/miesiąc", ctaCode: "Odblokuj najgorętsze doświadczenie AI — {price}/miesiąc" },
          it: { h: "Tutte le modelle, tutti i temi", p: "Qualsiasi modella, qualsiasi look, qualsiasi tema — video con lei, e tu dentro. Chattare resta gratis.", cta: "Sblocca l'esperienza AI più calda — {price}/mese", ctaCode: "Sblocca l'esperienza AI più calda — {price}/mese" },
        };
        const x = S[L] ?? S.en;
        return (
